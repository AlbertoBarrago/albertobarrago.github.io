...
> say hi: %s
> code: %s`,"color: #b8c4d4; font-family: monospace;",je,ye.github),console.log("%csteal the theme (dark CRT terminal palette):","color: #e0af68; font-family: monospace;"),console.log(Object.entries(St).map(([n,t])=>`${n}: ${t};`).join(`
...
<div class="timeline">${it.map(e=>`<article class="timeline-item">
	...
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function Be(){return`<div class="output-title">Selected projects</div>
