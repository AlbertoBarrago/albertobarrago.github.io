(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Ke="4.6.0",Ze={version:Ke},Ae="Alberto Barrago",Me="Senior Software Engineer",ke="Cagliari, Italy",De="albertobarrago@gmail.com",Pe="albertobarrago_cv.pdf",Qe="Senior Software Engineer with a product-builder mindset, turning ideas into scalable, production-ready tools that solve real-world problems.",et={frontend:["Angular","React","Vanilla JS"],backend:["Node.js","Fastify","FastAPI","Flask","Spring Boot"],apple:["Swift","SwiftUI","SwiftData","AppKit","iOS/macOS"],database:["MongoDB","Oracle","MySQL"],devops:["Docker","GitHub/GitLab CI","Azure DevOps"],tools:["Git","Neovim","tmux","Zed"],ai:["LLM Integration","Prompt Engineering","AI Agents"]},tt=[{role:"Tech Leader / Senior Software Engineer",company:"C22 Consulting",period:"2026 - Present",highlight:"Leading React, iOS, and Java architecture across active projects; mentoring developers and evangelizing AI workflows with Claude and MCP"},{role:"Senior Software Engineer / DevOps",company:"Minsait/Indra",period:"2023 - 2025",highlight:"Angular component library for 6+ teams, DevOps ownership, CI/CD optimization -30% deploy time"},{role:"Senior Software Developer",company:"Softfobia",period:"2022 - 2023",highlight:"Led full-stack teams, 20% load time improvement"},{role:"Software Developer",company:"Accenture",period:"2021 - 2022",highlight:"Kafka microservices architecture, Angular 12 apps"},{role:"Software Developer",company:"Sinossi",period:"2016 - 2021",highlight:"Mobile apps for Deutsche Bank, TIM (Fortune 500)"}],nt=[{name:"Markasso",description:"A fast, minimal, keyboard-first whiteboard engine for the browser. Marker + Picasso. No framework. No runtime. Just canvas.",url:"https://markasso.it",language:"TypeScript (0 deps)",status:"Experimental · Work in progress",focus:"Validating a direct, distraction-free interaction model for visual thinking."},{name:"Iron Doctrine",description:"A real-time strategy game with a deterministic ECS engine, running React + Pixi.js on the client, with lockstep online 1v1 multiplayer.",url:"https://iron-doctrine-omega.vercel.app/",language:"TypeScript (pnpm monorepo)",status:"Experimental · Work in progress",focus:"Deterministic simulation shared across local and networked play, driven by command replay."}],it=[{name:"RSS-Reader",description:"A lightweight, native macOS RSS Reader app built with Swift. Lives in your menu bar: clean, minimal, no bloat.",url:"https://github.com/AlbertoBarrago/RSS-Reader",language:"Swift"},{name:"Timelog",description:"A lightweight time-tracking app for iOS and macOS built with SwiftUI and SwiftData.",url:"https://github.com/AlbertoBarrago/Timelog",language:"Swift"},{name:"DockDock",description:"A native macOS utility that shows live window previews when you hover over Dock icons.",url:"https://github.com/AlbertoBarrago/DockDock",language:"Swift"},{name:"Sgommello",description:"Break reminder for macOS: a monster breaks your screen until you take a real break.",url:"https://github.com/AlbertoBarrago/Sgommello",language:"Swift"}],ot=[{name:"wir",description:"What Is Running - Port and Process Inspector.",install:"brew install AlbertoBarrago/tap/wir",url:"https://github.com/AlbertoBarrago/wir",tap:"AlbertoBarrago/tap"},{name:"jm",description:"Switch between JDKs registered with macOS. Primary shell command: jm.",install:"brew install AlbertoBarrago/tap/jm",url:"https://github.com/AlbertoBarrago/jm",tap:"AlbertoBarrago/tap"},{name:"serval",description:"Local-first CLI that estimates the blast radius of a code change. Primary shell command: serval.",install:"brew install AlbertoBarrago/tap/serval",url:"https://github.com/AlbertoBarrago/serval",tap:"AlbertoBarrago/tap"},{name:"otelma",description:"A local LLM inference runtime, built from scratch in Go for Apple Silicon on top of llama.cpp. Smaller and more didactic than Ollama, with a configurable unified memory budget as an explicit constraint. v0.2.",install:"brew install AlbertoBarrago/tap/otelma",url:"https://github.com/AlbertoBarrago/otelma",tap:"AlbertoBarrago/tap"}],at=[{category:"Free programming books",items:[{name:"Free Programming Books (IT)",description:"Curated list of free programming books in Italian.",url:"https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-it.md"},{name:"Free Programming Books (EN)",description:"The full English-language list of free programming books.",url:"https://github.com/EbookFoundation/free-programming-books"},{name:"The Odin Project",description:"Free, open-source full-stack curriculum (HTML/CSS, JS, Node, Rails).",url:"https://www.theodinproject.com/"},{name:"freeCodeCamp",description:"Free certifications and interactive courses for web development.",url:"https://www.freecodecamp.org/"}]},{category:"Free courses & practice",items:[{name:"Exercism",description:"Free coding exercises and mentoring across 70+ languages.",url:"https://exercism.org/"},{name:"Roadmap.sh",description:"Step-by-step roadmaps and guides for developer roles.",url:"https://roadmap.sh/"},{name:"Khan Academy",description:"Free courses in math, science, and computer programming.",url:"https://www.khanacademy.org/"},{name:"MIT OpenCourseWare",description:"Free lecture notes, exams, and videos from MIT courses.",url:"https://ocw.mit.edu/"}]},{category:"Docs & references",items:[{name:"MDN Web Docs",description:"The definitive reference for web platform technologies.",url:"https://developer.mozilla.org/"},{name:"DevDocs",description:"Fast, offline-capable API documentation browser.",url:"https://devdocs.io/"},{name:"Explain Shell",description:"Paste a shell command to see what each part does.",url:"https://explainshell.com/"},{name:"Regex101",description:"Online regex tester and debugger with live explanation.",url:"https://regex101.com/"}]},{category:"Free tools & perks",items:[{name:"Markasso",description:"My own fast, minimal, keyboard-first whiteboard engine. Marker + Picasso. No framework. No runtime. Just canvas.",url:"https://markasso.it"},{name:"GitHub Student Pack",description:"Free developer tools and credits for students.",url:"https://education.github.com/pack"},{name:"Coolors",description:"Free color palette generator and contrast checker.",url:"https://coolors.co/"},{name:"TinyPNG",description:"Compress PNG/WebP images for the web, free tier.",url:"https://tinypng.com/"}]}],ge={github:"https://github.com/AlbertoBarrago",email:`mailto:${De}`,bsky:"https://bsky.app/profile/albzoser.bsky.social"},_e=Ze.version,rt=()=>{const e=document.createElement("a");e.href=Pe,e.download=Pe,e.dispatchEvent(new MouseEvent("click"))};function lt(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=8,i=5,o=32,l=24,p=12,b=40,A=20,k=3,S=12,r=5,_=7,q=4,W=.003,L=["#ff6b6b","#ff6b6b","#ffbd2e","#ffbd2e","#00ff41"],I=1e3/60;let u="waiting",y=0,O=3,M=parseInt(localStorage.getItem("spaceInvadersHigh")||"0",10),B=0,F=0,m=0,x=[],v=[],R=[];function s(){const c=e.width||e.clientWidth||1,g=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const w=e.width/c,U=e.height/g;m=Math.max(0,Math.min(e.width-b,m*w));for(const X of x)X.x*=w,X.y*=U;for(const X of v)X.x*=w,X.y*=U;for(const X of R)X.x*=w,X.y*=U;u!=="playing"&&(m=e.width/2-b/2)}s();const T=new ResizeObserver(s);T.observe(e);const $=()=>e.height-40;let E=1,f=0,D=40;const H=10,V=20;function C(){x=[];const c=a*(o+p)-p,g=(e.width-c)/2;for(let w=0;w<i;w++)for(let U=0;U<a;U++)x.push({x:g+U*(o+p),y:60+w*(l+p),row:w,alive:!0});E=1,f=0,D=40}let j=0;const z={};function K(c){if(c.key==="Escape"){n();return}(u==="waiting"||u==="gameover"||u==="won")&&c.key==="Enter"&&(u="playing",y=0,O=3,v=[],R=[],m=e.width/2-b/2,C()),z[c.key]=!0,(c.key===" "||c.key==="ArrowLeft"||c.key==="ArrowRight")&&c.preventDefault()}function se(c){z[c.key]=!1}window.addEventListener("keydown",K),window.addEventListener("keyup",se);function me(c){if(u==="playing"){z.ArrowLeft&&m>0&&(m-=r*c),z.ArrowRight&&m<e.width-b&&(m+=r*c),m=Math.max(0,Math.min(e.width-b,m)),j>0&&(j=Math.max(0,j-c)),z[" "]&&j===0&&(v.push({x:m+b/2-k/2,y:$()-S}),j=15);for(let g=v.length-1;g>=0;g--){if(v[g].y-=_*c,v[g].y<0){v.splice(g,1);continue}for(const w of x)if(w.alive&&v[g]&&v[g].x<w.x+o&&v[g].x+k>w.x&&v[g].y<w.y+l&&v[g].y+S>w.y){w.alive=!1,v.splice(g,1),y+=10,y>M&&(M=y,localStorage.setItem("spaceInvadersHigh",String(M)));const U=x.filter(X=>X.alive).length;U>0&&(D=Math.max(4,Math.floor(40*(U/(i*a)))));break}}if(x.every(g=>!g.alive)){u="won";return}if(f+=c,f>=D){f=0;let g=!1;for(const w of x)if(w.alive&&(E>0&&w.x+o+H>e.width-10||E<0&&w.x-H<10)){g=!0;break}if(g){E*=-1;for(const w of x)w.y+=V}else for(const w of x)w.x+=H*E;for(const w of x)if(w.alive&&w.y+l>=$()){u="gameover";return}}for(const g of x.filter(w=>w.alive))Math.random()<W*c&&R.push({x:g.x+o/2-k/2,y:g.y+l});for(let g=R.length-1;g>=0;g--){if(R[g].y+=q*c,R[g].y>e.height){R.splice(g,1);continue}if(R[g].x<m+b&&R[g].x+k>m&&R[g].y<$()+A&&R[g].y+S>$()&&(R.splice(g,1),O--,O<=0)){u="gameover";return}}}}function he(){if(t){if(t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height),u==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("SPACE INVADERS",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrows = Move | Fire = Shoot",e.width/2,e.height/2+50),t.fillText("ESC = Exit | High Score: "+M,e.width/2,e.height/2+78),t.textAlign="left";return}t.fillStyle="#00bfff",t.beginPath(),t.moveTo(m+b/2,$()),t.lineTo(m,$()+A),t.lineTo(m+b,$()+A),t.closePath(),t.fill();for(const c of x)c.alive&&(t.fillStyle=L[c.row],t.fillRect(c.x+4,c.y,o-8,l-4),t.fillRect(c.x+2,c.y+4,6,4),t.fillRect(c.x+o-8,c.y+4,6,4),t.fillRect(c.x+6,c.y-4,3,6),t.fillRect(c.x+o-9,c.y-4,3,6),t.fillRect(c.x,c.y+l-6,4,6),t.fillRect(c.x+o-4,c.y+l-6,4,6));t.fillStyle="#00ff41";for(const c of v)t.fillRect(c.x,c.y,k,S);t.fillStyle="#ff6b6b";for(const c of R)t.fillRect(c.x,c.y,k,S);t.fillStyle="#00ff41",t.font="22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+y,10,24),t.textAlign="center",t.fillText("HIGH: "+M,e.width/2,24),t.textAlign="right",t.fillText("LIVES: "+"♥".repeat(O),e.width-10,24),t.textAlign="left",u==="gameover"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+y,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left"),u==="won"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("YOU WIN!",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+y,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO PLAY AGAIN",e.width/2,e.height/2+60),t.textAlign="left")}}function ue(c){F===0&&(F=c);const g=Math.min((c-F)/I,3);F=c,me(g),he(),B=requestAnimationFrame(ue)}return C(),B=requestAnimationFrame(ue),function(){cancelAnimationFrame(B),window.removeEventListener("keydown",K),window.removeEventListener("keyup",se),T.disconnect()}}const ae=10,le=20,Oe=[{shape:[[1,1,1,1]],color:"#00bfff"},{shape:[[1,1],[1,1]],color:"#ffbd2e"},{shape:[[0,1,0],[1,1,1]],color:"#a855f7"},{shape:[[1,0,0],[1,1,1]],color:"#ff6b6b"},{shape:[[0,0,1],[1,1,1]],color:"#00ff41"},{shape:[[0,1,1],[1,1,0]],color:"#ff6b6b"},{shape:[[1,1,0],[0,1,1]],color:"#00ff41"}];function st(){const e=[];for(let n=0;n<le;n++)e.push(new Array(ae).fill(null));return e}function ct(e,n,t,a){for(let i=0;i<n.length;i++)for(let o=0;o<n[i].length;o++){if(!n[i][o])continue;const l=t+o,p=a+i;if(l<0||l>=ae||p>=le||p>=0&&e[p][l])return!0}return!1}function dt(e){const n=e.length,t=e[0].length,a=[];for(let i=0;i<t;i++){a.push([]);for(let o=n-1;o>=0;o--)a[i].push(e[o][i])}return a}function pt(e){let n=0;for(let t=le-1;t>=0;t--)e[t].every(a=>a!==null)&&(e.splice(t,1),e.unshift(new Array(ae).fill(null)),n++,t++);return n}function mt(e,n){return e<=0?0:([0,100,300,500,800][e]||800)*n}function ht(e){const n=Math.floor(e/10)+1,t=Math.max(5,45-(n-1)*4);return{level:n,dropInterval:t}}function ut(e,n){const t=e.getContext("2d");if(!t)return()=>{};let a="waiting",i=0,o=1,l=0,p=parseInt(localStorage.getItem("tetrisHigh")||"0",10),b=0,A=0;const k=1e3/60;let S=[],r=null,_=0,q=45;function W(){e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight)}W();const L=new ResizeObserver(W);L.observe(e);function I(){S=st()}function u(s,T,$){return ct(S,s,T,$)}function y(){const s=Oe[Math.floor(Math.random()*Oe.length)];r={shape:s.shape.map(T=>[...T]),color:s.color,x:Math.floor((ae-s.shape[0].length)/2),y:0},u(r.shape,r.x,r.y)&&(a="gameover",r=null)}function O(){if(r){for(let s=0;s<r.shape.length;s++)for(let T=0;T<r.shape[s].length;T++){if(!r.shape[s][T])continue;const $=r.y+s;$>=0&&(S[$][r.x+T]=r.color)}M(),y()}}function M(){const s=pt(S);s>0&&(i+=mt(s,o),l+=s,{level:o,dropInterval:q}=ht(l),i>p&&(p=i,localStorage.setItem("tetrisHigh",String(p))))}const B={};function F(s){if(s.key==="Escape"){n();return}if((a==="waiting"||a==="gameover")&&s.key==="Enter"&&(a="playing",i=0,o=1,l=0,q=45,I(),y()),a!=="playing"||!r){B[s.key]=!0;return}if(s.key==="ArrowLeft")u(r.shape,r.x-1,r.y)||r.x--;else if(s.key==="ArrowRight")u(r.shape,r.x+1,r.y)||r.x++;else if(s.key==="ArrowDown")u(r.shape,r.x,r.y+1)?O():r.y++;else if(s.key==="ArrowUp"||s.key===" "){const T=dt(r.shape);u(T,r.x,r.y)?u(T,r.x-1,r.y)?u(T,r.x+1,r.y)||(r.shape=T,r.x++):(r.shape=T,r.x--):r.shape=T}B[s.key]=!0,["ArrowLeft","ArrowRight","ArrowDown","ArrowUp"," "].includes(s.key)&&s.preventDefault()}function m(s){B[s.key]=!1}window.addEventListener("keydown",F),window.addEventListener("keyup",m);function x(s){a!=="playing"||!r||(_+=s,_>=q&&(_=0,u(r.shape,r.x,r.y+1)?O():r.y++))}function v(){if(!t)return;t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height);const s=e.width<520,T=s?20:200,$=s?96:60,E=Math.max(8,Math.min(Math.floor((e.height-$)/le),Math.floor((e.width-T)/ae))),f=E*ae,D=E*le,H=Math.floor((e.width-f)/2),V=Math.max(s?68:36,Math.floor((e.height-D)/2)+10);if(a==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("TETRIS",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrows = Move | Up/Space = Rotate",e.width/2,e.height/2+50),t.fillText("ESC = Exit | High Score: "+p,e.width/2,e.height/2+78),t.textAlign="left";return}t.strokeStyle="#333",t.lineWidth=2,t.strokeRect(H-1,V-1,f+2,D+2);for(let C=0;C<le;C++)for(let j=0;j<ae;j++){const z=H+j*E,K=V+C*E;S[C][j]?(t.fillStyle=S[C][j],t.fillRect(z+1,K+1,E-2,E-2)):(t.fillStyle="#111",t.fillRect(z,K,E,E),t.strokeStyle="#1a1a1a",t.lineWidth=.5,t.strokeRect(z,K,E,E))}if(r){t.fillStyle=r.color;for(let C=0;C<r.shape.length;C++)for(let j=0;j<r.shape[C].length;j++){if(!r.shape[C][j])continue;const z=H+(r.x+j)*E,K=V+(r.y+C)*E;t.fillRect(z+1,K+1,E-2,E-2)}}t.fillStyle="#00ff41",t.font=s?"18px VT323, monospace":"22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+i,10,24),t.fillText("LEVEL: "+o,10,s?46:50),t.textAlign="center",t.fillText("HIGH: "+p,e.width/2,24),t.textAlign="right",t.fillText("LINES: "+l,e.width-10,24),t.textAlign="left",a==="gameover"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+i+"  Lines: "+l,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left")}function R(s){A===0&&(A=s);const T=Math.min((s-A)/k,3);A=s,x(T),v(),b=requestAnimationFrame(R)}return I(),b=requestAnimationFrame(R),function(){cancelAnimationFrame(b),window.removeEventListener("keydown",F),window.removeEventListener("keyup",m),L.disconnect()}}function ft(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=12,i=80,o=10,l=5,p=4,b=3.5,A=7,k=1e3/60;let S="waiting",r=0,_=0,q=0,W=0,L=0,I=0,u=0,y=0,O=p,M=p*.5;function B(){const f=e.width||e.clientWidth||1,D=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const H=e.width/f,V=e.height/D;L=Math.max(0,Math.min(e.height-i,L*V)),I=Math.max(0,Math.min(e.height-i,I*V)),u=Math.max(0,Math.min(e.width-o,u*H)),y=Math.max(0,Math.min(e.height-o,y*V)),S!=="playing"&&(L=e.height/2-i/2,I=e.height/2-i/2,u=e.width/2,y=e.height/2)}B();const F=new ResizeObserver(B);F.observe(e);function m(){u=e.width/2,y=e.height/2,O=p*(Math.random()>.5?1:-1),M=(Math.random()*2-1)*p*.5}const x={};function v(f){if(f.key==="Escape"){n();return}(S==="waiting"||S==="gameover")&&f.key==="Enter"&&(S="playing",r=0,_=0,L=e.height/2-i/2,I=e.height/2-i/2,m()),x[f.key]=!0,(f.key==="ArrowUp"||f.key==="ArrowDown")&&f.preventDefault()}function R(f){x[f.key]=!1}window.addEventListener("keydown",v),window.addEventListener("keyup",R);function s(f){if(S!=="playing")return;const D=e.getBoundingClientRect(),H=f.clientY-D.top;L=Math.max(0,Math.min(e.height-i,H-i/2)),f.preventDefault()}e.addEventListener("pointerdown",s),e.addEventListener("pointermove",s);function T(f){if(S!=="playing")return;x.ArrowUp&&L>0&&(L-=l*f),x.ArrowDown&&L<e.height-i&&(L+=l*f),L=Math.max(0,Math.min(e.height-i,L));const D=I+i/2;O>0?D<y-10?I+=b*f:D>y+10&&(I-=b*f):D<e.height/2-5?I+=b*.5*f:D>e.height/2+5&&(I-=b*.5*f),I=Math.max(0,Math.min(e.height-i,I)),u+=O*f,y+=M*f,y<=0&&(y=0,M=Math.abs(M)),y+o>=e.height&&(y=e.height-o,M=-Math.abs(M));const H=20;u<=H+a&&u+o>=H&&y+o>=L&&y<=L+i&&O<0&&(O=Math.abs(O)*1.05,M=((y+o/2-L)/i-.5)*p*2,u=H+a);const V=e.width-20-a;u+o>=V&&u<=V+a&&y+o>=I&&y<=I+i&&O>0&&(O=-Math.abs(O)*1.05,M=((y+o/2-I)/i-.5)*p*2,u=V-o),u<0&&(_++,_>=A?S="gameover":m()),u>e.width&&(r++,r>=A?S="gameover":m())}function $(){if(t){if(t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height),S==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("PONG",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrow Up/Down or Drag = Move",e.width/2,e.height/2+50),t.fillText("First to "+A+" wins | ESC = Exit",e.width/2,e.height/2+78),t.textAlign="left";return}if(t.setLineDash([8,8]),t.strokeStyle="#333",t.lineWidth=2,t.beginPath(),t.moveTo(e.width/2,0),t.lineTo(e.width/2,e.height),t.stroke(),t.setLineDash([]),t.fillStyle="#00ff41",t.fillRect(20,L,a,i),t.fillStyle="#ff6b6b",t.fillRect(e.width-20-a,I,a,i),t.fillStyle="#ffbd2e",t.fillRect(u,y,o,o),t.fillStyle="#00ff41",t.font="48px VT323, monospace",t.textAlign="center",t.fillText(String(r),e.width/2-60,55),t.fillStyle="#ff6b6b",t.fillText(String(_),e.width/2+60,55),t.textAlign="left",t.font="18px VT323, monospace",t.fillStyle="#888",t.textAlign="left",t.fillText("YOU",20,e.height-15),t.textAlign="right",t.fillText("CPU",e.width-20,e.height-15),t.textAlign="left",S==="gameover"){t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height);const f=r>=A;t.fillStyle=f?"#00ff41":"#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText(f?"YOU WIN!":"CPU WINS",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText(r+" - "+_,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left"}}}function E(f){W===0&&(W=f);const D=Math.min((f-W)/k,3);W=f,T(D),$(),q=requestAnimationFrame(E)}return q=requestAnimationFrame(E),function(){cancelAnimationFrame(q),window.removeEventListener("keydown",v),window.removeEventListener("keyup",R),e.removeEventListener("pointerdown",s),e.removeEventListener("pointermove",s),F.disconnect()}}function gt(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=24,i=.34,o=-6.6,l=58,p=168,b=2.15,A=126,k=46,S=1e3/60,r=100;let _="waiting",q=0,W=parseInt(localStorage.getItem("flappyBirdHigh")||"0",10),L=0,I=0,u=0,y=0,O=A,M=0,B=0,F=0,m=null,x=null,v=[];function R(){const d=e.width||e.clientWidth||1,h=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const N=e.width/d,Q=e.height/h;for(const P of v)P.x*=N,P.gapY=E(P.gapY*Q);_!=="playing"?T():(M=Math.max(50,Math.min(e.width-30,M*N)),B=Math.max(a,Math.min(e.height-k-a,B*Q)))}R();const s=new ResizeObserver(R);s.observe(e);function T(){M=Math.max(80,Math.floor(e.width*.28)),B=Math.floor(e.height*.45),F=0}function $(){const d=Math.max(160,e.height-k);return Math.max(86,Math.min(p,d-112))}function E(d){const h=$(),N=56,Q=Math.max(N,e.height-k-h-48);return Math.max(N,Math.min(Q,d))}function f(){_="playing",q=0,y=0,u=0,O=A,v=[],T(),D(),j()}function D(){const h=Math.max(68,e.height-k-$()-48),N=56+Math.random()*(h-56);v.push({x:e.width+20,gapY:N,passed:!1})}function H(){if(V(),_==="waiting"||_==="gameover"){f();return}_==="playing"&&(F=o,z())}function V(){if(m){m.state==="suspended"&&m.resume();return}const d=globalThis.AudioContext??globalThis.webkitAudioContext;m=new d,x=m.createGain(),x.gain.value=.16,x.connect(m.destination)}function C(d,h,N="square",Q=.2){if(!m||!x)return;const P=m.currentTime,ie=m.createOscillator(),oe=m.createGain();ie.type=N,ie.frequency.setValueAtTime(d,P),oe.gain.setValueAtTime(1e-4,P),oe.gain.exponentialRampToValueAtTime(Q,P+.01),oe.gain.exponentialRampToValueAtTime(1e-4,P+h),ie.connect(oe),oe.connect(x),ie.start(P),ie.stop(P+h+.02)}function j(){C(440,.08,"square",.14),m&&setTimeout(()=>C(660,.08,"square",.12),65)}function z(){C(720,.06,"square",.11)}function K(){C(880,.07,"triangle",.14),setTimeout(()=>C(1175,.08,"triangle",.12),60)}function se(){if(!m||!x)return;const d=m.currentTime,h=m.createOscillator(),N=m.createGain();h.type="sawtooth",h.frequency.setValueAtTime(190,d),h.frequency.exponentialRampToValueAtTime(60,d+.22),N.gain.setValueAtTime(.22,d),N.gain.exponentialRampToValueAtTime(1e-4,d+.24),h.connect(N),N.connect(x),h.start(d),h.stop(d+.26)}function me(d){if(d.key==="Escape"){n();return}(d.key==="Enter"||d.key===" ")&&(H(),d.preventDefault())}function he(){H()}window.addEventListener("keydown",me),e.addEventListener("pointerdown",he);function ue(){if(_!=="playing")return;for(y++,F+=i,B+=F;y>=O;)D(),O+=A;for(const P of v)P.x-=b,!P.passed&&P.x+l<M&&(P.passed=!0,q++,K(),q>W&&(W=q,localStorage.setItem("flappyBirdHigh",String(W))));v=v.filter(P=>P.x+l>-20);const d=M-a/2,h=M+a/2,N=B-a/2,Q=B+a/2;if(N<=0||Q>=e.height-k){_="gameover",se();return}for(const P of v){const ie=h>P.x&&d<P.x+l,oe=N<P.gapY,Je=Q>P.gapY+$();if(ie&&(oe||Je)){_="gameover",se();return}}}function c(){const d=t.createLinearGradient(0,0,0,e.height);d.addColorStop(0,"#082238"),d.addColorStop(1,"#071014"),t.fillStyle=d,t.fillRect(0,0,e.width,e.height),t.fillStyle="rgba(0, 255, 65, 0.08)";for(let h=y*-.3%90;h<e.width;h+=90)t.fillRect(h,80,34,8),t.fillRect(h+8,72,18,8)}function g(){const d=$();for(const h of v)t.fillStyle="#00a33a",t.fillRect(h.x,0,l,h.gapY),t.fillRect(h.x,h.gapY+d,l,e.height-k-h.gapY-d),t.fillStyle="#00ff41",t.fillRect(h.x-4,h.gapY-14,l+8,14),t.fillRect(h.x-4,h.gapY+d,l+8,14),t.fillStyle="rgba(0,0,0,0.22)",t.fillRect(h.x+l-12,0,6,h.gapY-14),t.fillRect(h.x+l-12,h.gapY+d+14,6,e.height-k)}function w(){const d=e.height-k;t.fillStyle="#332211",t.fillRect(0,d,e.width,k),t.fillStyle="#ffbd2e",t.fillRect(0,d,e.width,4),t.fillStyle="rgba(0, 255, 65, 0.35)";for(let h=y*-b%28;h<e.width;h+=28)t.fillRect(h,d+10,14,4)}function U(){const d=Math.max(-.45,Math.min(.7,F/12));t.save(),t.translate(M,B),t.rotate(d),t.fillStyle="#ffbd2e",t.fillRect(-12,-10,22,20),t.fillStyle="#ffe680",t.fillRect(-16,-2,14,10),t.fillStyle="#ff6b6b",t.fillRect(8,-2,12,6),t.fillStyle="#fff",t.fillRect(2,-8,6,6),t.fillStyle="#0a0a0a",t.fillRect(6,-6,2,2),t.restore()}function X(){t.fillStyle="#00ff41",t.font="22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+q,10,24),t.textAlign="center",t.fillText("HIGH: "+W,e.width/2,24),t.textAlign="right",t.fillText("SPACE = FLAP",e.width-10,24),t.textAlign="left"}function ze(){t.fillStyle="rgba(0,0,0,0.45)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("FLAPPY BIRD",e.width/2,e.height/2-70),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS SPACE OR CLICK TO START",e.width/2,e.height/2),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Space/Click = Flap",e.width/2,e.height/2+40),t.fillText("ESC = Exit | High Score: "+W,e.width/2,e.height/2+70),t.textAlign="left"}function Ue(){t.fillStyle="rgba(0,0,0,0.68)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-30),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+q,e.width/2,e.height/2+10),t.fillStyle="#888",t.fillText("PRESS SPACE OR CLICK TO RESTART",e.width/2,e.height/2+50),t.textAlign="left"}function Xe(){c(),g(),w(),U(),X(),_==="waiting"&&ze(),_==="gameover"&&Ue()}function Ce(d){I===0&&(I=d);const h=Math.min(d-I,r);for(I=d,u+=h;u>=S;)ue(),u-=S;Xe(),L=requestAnimationFrame(Ce)}return T(),L=requestAnimationFrame(Ce),function(){cancelAnimationFrame(L),window.removeEventListener("keydown",me),e.removeEventListener("pointerdown",he),s.disconnect(),m==null||m.close(),m=null,x=null}}const yt=Object.freeze({"--background":"#0b0f14","--background-deep":"#070a0e","--surface":"#111820","--foreground":"#b8c4d4","--bright":"#e7edf5","--muted":"#667485","--border":"#22303d","--cyan":"#5eead4","--blue":"#7aa2f7","--green":"#9ece6a","--yellow":"#e0af68","--purple":"#bb9af7","--red":"#f7768e"});function bt(){console.log(`%c    _    _     ____   _____
   / \\  | |   | __ ) |__  /
  / _ \\ | |   |  _ \\   / /
 / ___ \\| |___| |_) | / /_
...
> say hi: %s
> code: %s`,"color: #b8c4d4; font-family: monospace;",De,ge.github),console.log("%csteal the theme (dark CRT terminal palette):","color: #e0af68; font-family: monospace;"),console.log(Object.entries(yt).map(([n,t])=>`${n}: ${t};`).join(`
`))}function fe(e){return e.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[n]??n)}const wt={title:"Iron Doctrine: building deterministic online multiplayer with a shared ECS engine",date:"2026-08-31",tags:["typescript","game-dev","multiplayer","ecs","pnpm"]},St=`<p><strong>Iron Doctrine</strong> is a real-time strategy game I&#39;m building in a pnpm monorepo, with a deterministic ECS engine at its core and, as of this week, a working 1v1 online mode.</p>
...
`,kt=Object.freeze(Object.defineProperty({__proto__:null,html:St,meta:wt},Symbol.toStringTag,{value:"Module"})),xt={title:"Otelma: building a local LLM runtime from scratch",date:"2026-08-31",tags:["go","llm","llama-cpp","apple-silicon","ai"]},vt=`<p><strong>Otelma</strong> is a local LLM inference runtime I&#39;m building in Go.</p>
...
`,Tt=Object.freeze(Object.defineProperty({__proto__:null,html:vt,meta:xt},Symbol.toStringTag,{value:"Module"})),At={title:"I Built a CLI to Answer One Question: What Will This Change Break?",date:"2026-08-27",tags:["programming","devops","go","opensource"]},It=`<p>We&#39;ve all been there.</p>
...
`,Et=Object.freeze(Object.defineProperty({__proto__:null,html:It,meta:At},Symbol.toStringTag,{value:"Module"})),Lt={title:"wir: What Is Running, a Port and Process Inspector Written in C",date:"2025-12-30",tags:["c","systems-programming","cli","opensource"]},Mt=`<p>I recently released <strong>wir</strong> (What Is Running), a command-line tool written in C to inspect what&#39;s running on specific ports and get detailed process information. A project born from a practical need that turned into an opportunity to explore system programming in C.</p>
<h2>The Problem</h2>
...
`,_t=Object.freeze(Object.defineProperty({__proto__:null,html:Mt,meta:Lt},Symbol.toStringTag,{value:"Module"}));function Rt(e){return[...e].sort((n,t)=>n.date.localeCompare(t.date))}const Ct=Object.assign({"/src/content/articles/iron-doctrine.md":kt,"/src/content/articles/otelma.md":Tt,"/src/content/articles/serval-cli.md":Et,"/src/content/articles/wir-what-is-running.md":_t}),Ie=new Map,Z=Rt(Object.entries(Ct).map(([e,n])=>{const t=e.split("/").pop().replace(/\.md$/,"");return Ie.set(t,n.html),{slug:t,title:n.meta.title??t,date:n.meta.date??"",tags:n.meta.tags??[]}}));function de(e){return Ie.has(e)?Ie.get(e):null}const Be="alberto@portfolio:~",Pt=Object.freeze(["help","about","skills","experience","projects","brew","lab","articles","utils","contact","cv","games","play","ls","tree","neofetch","history","date","clear"]),Ot=Object.freeze([["help","help"],["about","about"],["skills","skills"],["projects","projects"],["brew","brew"],["lab","lab"],["articles","articles"],["utils","utils"],["games","games"],["contact","contact"]]),be=Object.freeze({space:"SPACE INVADERS",tetris:"TETRIS",pong:"PONG",flappy:"FLAPPY BIRD"}),$t=Object.freeze({space:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"FIRE",key:" "},{label:"→",key:"ArrowRight"}],tetris:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"ROT",key:"ArrowUp"},{label:"→",key:"ArrowRight"},{label:"↓",key:"ArrowDown"}],pong:[{label:"START",key:"Enter"},{label:"↑",key:"ArrowUp"},{label:"↓",key:"ArrowDown"}],flappy:[{label:"START",key:"Enter"},{label:"FLAP",key:" "}]}),He=Object.freeze({space:lt,tetris:ut,pong:ft,flappy:gt}),je=Object.freeze(["        /\\_/\\","       ( o.o )","        > ^ <","       /|   |\\","      (_|   |_)","         W W","","      I LOVE CAT"]),Ee=Object.freeze(["    _    _     ____   _____","   / \\  | |   | __ ) |__  /","  / _ \\ | |   |  _ \\   / /"," / ___ \\| |___| |_) | / /_","/_/   \\_\\_____|____/ /____|"]),$e="#%@*+=-<>/\\|",Dt=new Set(["ArrowLeft","ArrowRight","ArrowDown"]),pe=new Map,re=[];let ye=0,ce=null,ee=null,J=null;const ne=document.getElementById("app");function Bt(){const e=Ot.map(([n,t])=>`<button class="mobile-command" type="button" data-command="${t}">${n}</button>`).join("");return`<main class="terminal" aria-label="Alberto Barrago portfolio terminal">
	...
	<div class="crt-overlay" aria-hidden="true"></div>`}function Ht(){return`<div class="ascii-banner accent" role="img" aria-label="ALBZ">${Ee.join(`
`)}</div>
<div class="boot-copy"><span class="muted">Portfolio shell v${_e}</span>
<span>${Me} · Product Builder</span>
...
Type <button class="inline-command command" data-command="help">help</button> to explore, or use the shortcuts below.</div>`}function jt(){return`<div class="output-title">Available commands</div>
...
<div class="output-note">Tip: press <span class="key">Tab</span> to autocomplete and <span class="key">↑</span>/<span class="key">↓</span> for history.</div>`}function Gt(){return`<div class="output-title">${Ae}</div>
<div class="key-value"><span class="label">role</span><span>${Me}</span>
...
<p class="prose">${Qe}</p>
<div class="output-links"><button class="inline-command command" data-command="projects">view projects</button><button class="inline-command command" data-command="contact">contact me</button><button class="inline-command command" data-command="cv">download cv</button></div>`}function Nt(){return`<div class="output-title">Technical toolbox</div>
<div class="skills-list">${Object.entries(et).map(([e,n])=>`<div class="skill-row"><span class="label">${e}</span><span>${n.join("  ·  ")}</span></div>`).join("")}</div>`}function qt(){return`<div class="output-title">Experience</div>
<div class="timeline">${tt.map(e=>`<article class="timeline-item">
	<span class="timeline-period">${e.period}</span>
	<div><div><span class="green">${e.role}</span> <span class="muted">@ ${e.company}</span></div>
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function Ft(){return`<div class="output-title">Selected projects</div>
<div class="project-list">${it.map(e=>`<article class="project-item">
...
</article>`).join("")}</div>`}function Vt(){return`<div class="output-title">Workbench Lab</div>
<p class="prose">Experimental products in active development. Scope and direction may evolve as ideas are validated.</p>
${nt.map(n=>`<article class="project-item lab-project">
...
</article>`).join("")}`}function Ge(e){if(!e)return e;const n=new Date(`${e}T00:00:00`);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("it-IT",{day:"2-digit",month:"2-digit",year:"numeric"}).format(n)}function Yt(){return Z.length===0?`<div class="output-title">Articles</div>
...
<div class="project-list">${[...Z].sort((n,t)=>n.date.localeCompare(t.date)).map(n=>`<article class="project-item">
...
</article>`).join("")}</div>`}const zt=200;function Ut(e){const n=e.replace(/<[^>]*>/g," ").replace(/\s+/g," ").trim(),t=n?n.split(" ").length:0;return{words:t,chars:n.length,minutes:Math.max(1,Math.round(t/zt))}}function Xt(e){const n=Z.findIndex(p=>p.slug===e),t=Z[n],a=Ut(de(e)??""),i=Z[n-1],o=Z[n+1],l=[i?`<button class="reader-nav-link" type="button" data-action="read-article" data-slug="${i.slug}">← ${i.title}</button>`:"<span></span>",o?`<button class="reader-nav-link reader-nav-next" type="button" data-action="read-article" data-slug="${o.slug}">${o.title} →</button>`:"<span></span>"].join("");return`<div class="article-reader" id="article-reader">
	...
	</div>`}function Jt(e){return e.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}function Kt(e){const n=e.querySelector("#reader-toc"),t=e.querySelectorAll(".prose h2, .prose h3");if(t.length===0)return;const a=new Set,i=Array.from(t).map(l=>{let p=Jt(l.textContent??"");for(;a.has(p)||!p;)p=`${p||"section"}-${a.size+1}`;return a.add(p),l.id=p,{id:p,text:l.textContent??"",level:l.tagName==="H2"?2:3}});n.innerHTML=`<span class="reader-toc-title">chapters</span><ol class="reader-toc-list">${i.map(l=>`<li class="reader-toc-item level-${l.level}"><button class="reader-toc-link" type="button" data-action="goto-heading" data-target="${l.id}">${l.text}</button></li>`).join("")}</ol>`,n.hidden=!1,e.classList.add("has-toc");const o=e.querySelector("#reader-toc-toggle");o&&(o.hidden=!1),Zt(e,Array.from(t))}function Zt(e,n){ee==null||ee.disconnect(),J==null||J.container.removeEventListener("scroll",J.handler),J=null;const t=e.querySelector(".article-reader-body"),a=e.querySelectorAll(".reader-toc-link"),i=new Set,o=b=>{a.forEach(A=>A.classList.toggle("is-active",A.dataset.target===b))},l=()=>t.scrollTop+t.clientHeight>=t.scrollHeight-4;ee=new IntersectionObserver(b=>{for(const k of b)k.isIntersecting?i.add(k.target.id):i.delete(k.target.id);const A=n.find(k=>i.has(k.id));A?o(A.id):l()&&o(n[n.length-1].id)},{root:t,rootMargin:"0px 0px -72% 0px",threshold:0}),n.forEach(b=>ee.observe(b)),o(n[0].id);const p=()=>{l()&&o(n[n.length-1].id)};t.addEventListener("scroll",p,{passive:!0}),J={container:t,handler:p}}function xe(e){var a;(a=document.getElementById("article-reader"))==null||a.remove(),G.blur();const n=document.createElement("div");n.innerHTML=Xt(e);const t=n.firstElementChild;ne.appendChild(t),t.scrollTop=0,Kt(t),window.location.pathname!==`/articles/${e}/`&&window.history.pushState(null,"",`/articles/${e}/`)}function Ne(){var e;ee==null||ee.disconnect(),ee=null,J==null||J.container.removeEventListener("scroll",J.handler),J=null,(e=document.getElementById("article-reader"))==null||e.remove(),window.location.pathname.startsWith("/articles/")&&window.history.pushState(null,"","/"),G==null||G.focus({preventScroll:!0})}function Le(e){return`${window.location.origin}/articles/${e}/`}function Qt(e){const n=e.textContent;e.textContent="copied ✓",e.disabled=!0,window.setTimeout(()=>{e.textContent=n,e.disabled=!1},1500)}async function qe(e,n){try{await navigator.clipboard.writeText(Le(e)),Qt(n)}catch{window.prompt("Copy this link:",Le(e))}}async function en(e,n){const t=Z.find(i=>i.slug===e),a=Le(e);if(navigator.share){try{await navigator.share({title:(t==null?void 0:t.title)??e,url:a})}catch{}return}await qe(e,n)}function tn(){return`<div class="output-title">/utils</div>
<p class="prose">Useful free resources: books, courses, docs, and tools I keep coming back to.</p>
${at.map(e=>`<div class="utils-group">
...
</div>`).join("")}</div>`}function ve(){return`<div class="output-title">Let's build something useful</div>
...
<span class="label">location</span><span>${ke}</span></div>`}function nn(){return`<div class="output-title">/games</div>
...
<div class="output-note">Games open fullscreen. Press <span class="key">Esc</span> to return.</div>`}function on(){return`<div class="tree"><span class="blue">~</span>
...
└── <button class="inline-command directory" data-command="games">games/</button></div>`}function an(){return`<div class="neofetch"><div class="neofetch-mark" aria-hidden="true">╭─────╮
│ A B │
│ L Z │
╰─────╯</div><div><span class="accent">${Ae}</span>
<span class="muted">─${"─".repeat(Ae.length-1)}</span>
<span><span class="label">Role:</span> ${Me}</span>
<span><span class="label">Base:</span> ${ke}</span>
<span><span class="label">Stack:</span> JavaScript, Swift, Java, Python</span>
<span><span class="label">Shell:</span> albz-sh ${_e}</span>
<span><span class="label">Runtime:</span> Vanilla JS, zero dependencies</span>
<span class="palette"><i></i><i></i><i></i><i></i><i></i><i></i></span></div></div>`}function rn(){return'<div class="ls-output"><button class="inline-command file" data-command="about">about.txt</button><button class="inline-command directory" data-command="skills">skills/</button><button class="inline-command file" data-command="experience">experience.log</button><button class="inline-command directory" data-command="projects">projects/</button><button class="inline-command directory" data-command="brew">brew/</button><button class="inline-command directory" data-command="lab">lab/</button><button class="inline-command directory" data-command="articles">articles/</button><button class="inline-command directory" data-command="utils">utils/</button><button class="inline-command file" data-command="contact">contact.vcf</button><button class="inline-command directory" data-command="games">games/</button></div>'}function Fe(e,n){return e.map(t=>t.split("").map(a=>a===" "||Math.random()>=n?a:$e[Math.floor(Math.random()*$e.length)]).join("")).join(`
`)}function ln(e){return Fe(je,e)}function sn(){const e=te.querySelector(".ascii-banner");if(!e)return;const n=Ee.join(`
`),t=9;let a=0;const i=window.setInterval(()=>{if(a+=1,a>=t){window.clearInterval(i),e.textContent=n;return}e.textContent=Fe(Ee,Math.max(0,.55-a*.06))},70)}function cn(){const e=document.createElement("div");e.className="output-block ascii-banner accent",te.appendChild(e);const n=6;let t=0;const a=window.setInterval(()=>{t+=1,e.textContent=t>=n?je.join(`
`):ln(Math.max(0,.6-t*.12)),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight}),t>=n&&(window.clearInterval(a),Y('<span class="green">Purring in binary.</span>'))},90)}function dn(e){const n=document.createElement("div");n.className="output-block command-echo";const t=document.createElement("span");t.className="prompt",t.innerHTML=`<span class="prompt-user">${Be}</span><span class="prompt-symbol">$</span>`;const a=document.createElement("span");a.textContent=e,n.append(t,a),te.appendChild(n)}function Y(e,n=""){const t=document.createElement("div");t.className=`output-block ${n}`.trim(),t.innerHTML=e,te.appendChild(t),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight})}function We(e){const n=e.trim();if(!n)return;dn(n),re.at(-1)!==n&&re.push(n),ye=re.length;const[t,...a]=n.split(/\s+/),i=t.toLowerCase(),o=a.join(" ").toLowerCase();if(i==="clear"){te.replaceChildren();return}if(["about","whoami","cat"].includes(i)){i!=="cat"||!o||o==="about.txt"?Y(Gt()):o==="contact.vcf"?Y(ve()):o.endsWith(".md")&&de(o.slice(0,-3))?xe(o.slice(0,-3)):Y(`<span class="red">cat: ${fe(o)}: No such file</span>`);return}const l={help:jt,skills:Nt,experience:qt,projects:Ft,brew:Wt,lab:Vt,articles:Yt,utils:tn,contact:ve,games:nn,ls:rn,tree:on,neofetch:an};if(l[i]){Y(l[i]());return}if(i==="cv"){rt(),Y('<span class="green">Downloading albertobarrago_cv.pdf…</span>');return}if(i==="history"){Y(re.map((p,b)=>`<div><span class="muted">${String(b+1).padStart(3," ")}</span>  ${fe(p)}</div>`).join(""));return}if(i==="date"){Y(new Intl.DateTimeFormat("it-IT",{dateStyle:"full",timeStyle:"long"}).format(new Date));return}if(i==="play"){pn(o)?(Y(`<span class="green">Launching ${be[o]}…</span>`),hn(o)):Y(`<span class="red">Unknown game${o?`: ${fe(o)}`:""}.</span> Try <button class="inline-command command" data-command="games">games</button>.`);return}if(i==="1337"){cn();return}if(i==="sudo"&&o==="hire alberto"){Y('<span class="green">Permission granted. Opening contact details…</span>'),Y(ve());return}Y(`<span class="red">command not found: ${fe(i)}</span><br>Type <button class="inline-command command" data-command="help">help</button> to see available commands.`)}function pn(e){return Object.hasOwn(He,e)}function mn(e){const n=$t[e].map(t=>`<button class="game-control-button" type="button" data-control-key="${t.key}">${t.label}</button>`).join("");return`<div class="game-fullscreen" id="game-overlay">
	...
	</div>`}function hn(e){we(),G.blur();const n=document.createElement("div");n.innerHTML=mn(e);const t=n.firstElementChild;ne.appendChild(t);const a=t.querySelector(".game-canvas");requestAnimationFrame(()=>{t.isConnected&&(ce=He[e](a,we))})}function we(){var e;ce==null||ce(),ce=null,Ve(),(e=document.getElementById("game-overlay"))==null||e.remove(),G==null||G.focus({preventScroll:!0})}function Se(e,n){window.dispatchEvent(new KeyboardEvent(n,{key:e,bubbles:!0,cancelable:!0}))}function un(e){var o;const t=e.target.closest("[data-control-key]"),a=t==null?void 0:t.dataset.controlKey;if(!t||!a)return;e.preventDefault(),(o=t.setPointerCapture)==null||o.call(t,e.pointerId);const i={key:a,button:t};pe.set(e.pointerId,i),t.classList.add("is-pressed"),Se(a,"keydown"),Dt.has(a)&&(i.delayId=window.setTimeout(()=>{i.intervalId=window.setInterval(()=>Se(a,"keydown"),85)},220))}function Re(e){const n=pe.get(e.pointerId);n&&(e.preventDefault(),n.delayId&&window.clearTimeout(n.delayId),n.intervalId&&window.clearInterval(n.intervalId),n.button.classList.remove("is-pressed"),pe.delete(e.pointerId),Se(n.key,"keyup"))}function Ve(){for(const e of pe.values())e.delayId&&window.clearTimeout(e.delayId),e.intervalId&&window.clearInterval(e.intervalId),e.button.classList.remove("is-pressed"),Se(e.key,"keyup");pe.clear()}ne.innerHTML=Bt();const te=document.getElementById("terminal-output"),fn=document.getElementById("terminal-form"),G=document.getElementById("terminal-input");Y(Ht(),"welcome-block");sn();bt();function Ye(){var e,n;return((e=window.location.pathname.match(/^\/articles\/([^/]+)\/?$/))==null?void 0:e[1])??((n=window.location.hash.match(/^#article\/(.+)$/))==null?void 0:n[1])}const Te=Ye();Te&&de(Te)&&xe(Te);window.addEventListener("popstate",()=>{var n;const e=Ye();e&&de(e)?xe(e):(n=document.getElementById("article-reader"))==null||n.remove()});fn.addEventListener("submit",e=>{e.preventDefault();const n=G.value;G.value="",We(n)});G.addEventListener("keydown",e=>{if(e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const n=e.key==="ArrowUp"?-1:1;ye=Math.max(0,Math.min(re.length,ye+n)),G.value=re[ye]??"",requestAnimationFrame(()=>G.setSelectionRange(G.value.length,G.value.length));return}if(e.key==="Tab"){e.preventDefault();const n=G.value.trim().toLowerCase(),t=Pt.filter(a=>a.startsWith(n));t.length===1?G.value=t[0]:t.length>1&&Y(t.map(a=>`<span class="command">${a}</span>`).join("  "))}});ne.addEventListener("click",e=>{var b,A,k;const n=e.target,t=document.querySelector("#reader-toc.is-open");t&&!n.closest("#reader-toc")&&!n.closest('[data-action="toggle-toc"]')&&t.classList.remove("is-open");const a=n.closest('[data-action="read-article"]');if(a!=null&&a.dataset.slug){xe(a.dataset.slug);return}if(n.closest('[data-action="close-reader"]')){Ne();return}const i=n.closest('[data-action="share-article"]');if(i!=null&&i.dataset.slug){en(i.dataset.slug,i);return}const o=n.closest('[data-action="copy-article-link"]');if(o!=null&&o.dataset.slug){qe(o.dataset.slug,o);return}if(n.closest('[data-action="toggle-toc"]')){(b=document.getElementById("reader-toc"))==null||b.classList.toggle("is-open");return}const l=n.closest('[data-action="goto-heading"]');if(l!=null&&l.dataset.target){const S=document.getElementById("article-reader");(A=document.getElementById(l.dataset.target))==null||A.scrollIntoView({behavior:"smooth",block:"start"}),(k=S==null?void 0:S.querySelector("#reader-toc"))==null||k.classList.remove("is-open");return}const p=n.closest("[data-command]");p!=null&&p.dataset.command&&We(p.dataset.command),n.closest('[data-action="exit-game"]')&&we(),!n.closest("a")&&!document.getElementById("game-overlay")&&!document.getElementById("article-reader")&&G.focus({preventScroll:!0})});ne.addEventListener("pointerdown",un);ne.addEventListener("pointerup",Re);ne.addEventListener("pointercancel",Re);ne.addEventListener("lostpointercapture",Re);window.addEventListener("blur",Ve);document.addEventListener("keydown",e=>{e.key==="Escape"&&document.getElementById("game-overlay")&&we(),e.key==="Escape"&&document.getElementById("article-reader")&&Ne()});
