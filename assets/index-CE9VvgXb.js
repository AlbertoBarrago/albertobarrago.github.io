...
> say hi: %s
> code: %s`,"color: #b8c4d4; font-family: monospace;",$e,ge.github),console.log("%csteal the theme (dark CRT terminal palette):","color: #e0af68; font-family: monospace;"),console.log(Object.entries(ft).map(([n,t])=>`${n}: ${t};`).join(`
`))}function fe(e){return e.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[n]??n)}const yt={title:"Iron Doctrine: building deterministic online multiplayer with a shared ECS engine",date:"2026-08-31",tags:["typescript","game-dev","multiplayer","ecs","pnpm"]},bt=`<p><strong>Iron Doctrine</strong> is a real-time strategy game I&#39;m building in a pnpm monorepo, with a deterministic ECS engine at its core and, as of this week, a working 1v1 online mode.</p>
...
`,wt=Object.freeze(Object.defineProperty({__proto__:null,html:bt,meta:yt},Symbol.toStringTag,{value:"Module"})),St={title:"Otelma: building a local LLM runtime from scratch",date:"2026-08-31",tags:["go","llm","llama-cpp","apple-silicon","ai"]},kt=`<p><strong>Otelma</strong> is a local LLM inference runtime I&#39;m building in Go.</p>
...
`,xt=Object.freeze(Object.defineProperty({__proto__:null,html:kt,meta:St},Symbol.toStringTag,{value:"Module"})),vt={title:"I Built a CLI to Answer One Question: What Will This Change Break?",date:"2026-08-27",tags:["programming","devops","go","opensource"]},Tt=`<p>We&#39;ve all been there.</p>
...
`,At=Object.freeze(Object.defineProperty({__proto__:null,html:Tt,meta:vt},Symbol.toStringTag,{value:"Module"})),It={title:"wir: What Is Running, a Port and Process Inspector Written in C",date:"2025-12-30",tags:["c","systems-programming","cli","opensource"]},Et=`<p>I recently released <strong>wir</strong> (What Is Running), a command-line tool written in C to inspect what&#39;s running on specific ports and get detailed process information. A project born from a practical need that turned into an opportunity to explore system programming in C.</p>
<h2>The Problem</h2>
...
`,Lt=Object.freeze(Object.defineProperty({__proto__:null,html:Et,meta:It},Symbol.toStringTag,{value:"Module"}));function Mt(e){return[...e].sort((n,t)=>n.date.localeCompare(t.date))}const _t=Object.assign({"/src/content/articles/iron-doctrine.md":wt,"/src/content/articles/otelma.md":xt,"/src/content/articles/serval-cli.md":At,"/src/content/articles/wir-what-is-running.md":Lt}),Ie=new Map,Z=Mt(Object.entries(_t).map(([e,n])=>{const t=e.split("/").pop().replace(/\.md$/,"");return Ie.set(t,n.html),{slug:t,title:n.meta.title??t,date:n.meta.date??"",tags:n.meta.tags??[]}}));function de(e){return Ie.has(e)?Ie.get(e):null}const De="alberto@portfolio:~",Rt=Object.freeze(["help","about","skills","experience","projects","brew","lab","articles","utils","contact","cv","games","play","ls","tree","neofetch","history","date","clear"]),Ct=Object.freeze([["help","help"],["about","about"],["skills","skills"],["projects","projects"],["brew","brew"],["lab","lab"],["articles","articles"],["utils","utils"],["games","games"],["contact","contact"]]),be=Object.freeze({space:"SPACE INVADERS",tetris:"TETRIS",pong:"PONG",flappy:"FLAPPY BIRD"}),Pt=Object.freeze({space:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"FIRE",key:" "},{label:"→",key:"ArrowRight"}],tetris:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"ROT",key:"ArrowUp"},{label:"→",key:"ArrowRight"},{label:"↓",key:"ArrowDown"}],pong:[{label:"START",key:"Enter"},{label:"↑",key:"ArrowUp"},{label:"↓",key:"ArrowDown"}],flappy:[{label:"START",key:"Enter"},{label:"FLAP",key:" "}]}),Be=Object.freeze({space:at,tetris:ht,pong:mt,flappy:ut}),He=Object.freeze(["        /\\_/\\","       ( o.o )","        > ^ <","       /|   |\\","      (_|   |_)","         W W","","      I LOVE CAT"]),Oe="#%@*+=-<>/\\|",Ot=new Set(["ArrowLeft","ArrowRight","ArrowDown"]),pe=new Map,re=[];let ye=0,ce=null,ee=null,J=null;const ne=document.getElementById("app");function $t(){const e=Ct.map(([n,t])=>`<button class="mobile-command" type="button" data-command="${t}">${n}</button>`).join("");return`<main class="terminal" aria-label="Alberto Barrago portfolio terminal">
		...
		<div class="terminal-bottom">
			<form class="terminal-input-line" id="terminal-form" autocomplete="off">
				...
				<span class="prompt" aria-hidden="true"><span class="prompt-user">${De}</span><span class="prompt-symbol">$</span></span>
	...
	<div class="crt-overlay" aria-hidden="true"></div>`}function Dt(){return`<div class="ascii-banner accent" role="img" aria-label="ALBZ">    _    _     ____   _____
   / \\  | |   | __ ) |__  /
  / _ \\ | |   |  _ \\   / /
 / ___ \\| |___| |_) | / /_
...
<div class="output-note">Tip: press <span class="key">Tab</span> to autocomplete and <span class="key">↑</span>/<span class="key">↓</span> for history.</div>`}function Ht(){return`<div class="output-title">${Ae}</div>
...
<p class="prose">${Ke}</p>
<div class="output-links"><button class="inline-command command" data-command="projects">view projects</button><button class="inline-command command" data-command="contact">contact me</button><button class="inline-command command" data-command="cv">download cv</button></div>`}function jt(){return`<div class="output-title">Technical toolbox</div>
<div class="skills-list">${Object.entries(Ze).map(([e,n])=>`<div class="skill-row"><span class="label">${e}</span><span>${n.join("  ·  ")}</span></div>`).join("")}</div>`}function Gt(){return`<div class="output-title">Experience</div>
<div class="timeline">${Qe.map(e=>`<article class="timeline-item">
	...
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function Nt(){return`<div class="output-title">Selected projects</div>
<div class="project-list">${tt.map(e=>`<article class="project-item">
	...
	<p>${e.description}</p>
</article>`).join("")}</div>`}function qt(){return`<div class="output-title">Homebrew formulae</div>
...
</article>`).join("")}</div>`}function Ft(){return`<div class="output-title">Workbench Lab</div>
...
<div class="project-list">${[...Z].sort((n,t)=>n.date.localeCompare(t.date)).map(n=>`<article class="project-item">
...
</article>`).join("")}</div>`}const Vt=200;function Yt(e){const n=e.replace(/<[^>]*>/g," ").replace(/\s+/g," ").trim(),t=n?n.split(" ").length:0;return{words:t,chars:n.length,minutes:Math.max(1,Math.round(t/Vt))}}function zt(e){const n=Z.findIndex(p=>p.slug===e),t=Z[n],a=Yt(de(e)??""),i=Z[n-1],o=Z[n+1],l=[i?`<button class="reader-nav-link" type="button" data-action="read-article" data-slug="${i.slug}">← ${i.title}</button>`:"<span></span>",o?`<button class="reader-nav-link reader-nav-next" type="button" data-action="read-article" data-slug="${o.slug}">${o.title} →</button>`:"<span></span>"].join("");return`<div class="article-reader" id="article-reader">
	...
	</div>`}function Ut(e){return e.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}function Xt(e){const n=e.querySelector("#reader-toc"),t=e.querySelectorAll(".prose h2, .prose h3");if(t.length===0)return;const a=new Set,i=Array.from(t).map(l=>{let p=Ut(l.textContent??"");for(;a.has(p)||!p;)p=`${p||"section"}-${a.size+1}`;return a.add(p),l.id=p,{id:p,text:l.textContent??"",level:l.tagName==="H2"?2:3}});n.innerHTML=`<span class="reader-toc-title">chapters</span><ol class="reader-toc-list">${i.map(l=>`<li class="reader-toc-item level-${l.level}"><button class="reader-toc-link" type="button" data-action="goto-heading" data-target="${l.id}">${l.text}</button></li>`).join("")}</ol>`,n.hidden=!1,e.classList.add("has-toc");const o=e.querySelector("#reader-toc-toggle");o&&(o.hidden=!1),Jt(e,Array.from(t))}function Jt(e,n){ee==null||ee.disconnect(),J==null||J.container.removeEventListener("scroll",J.handler),J=null;const t=e.querySelector(".article-reader-body"),a=e.querySelectorAll(".reader-toc-link"),i=new Set,o=b=>{a.forEach(A=>A.classList.toggle("is-active",A.dataset.target===b))},l=()=>t.scrollTop+t.clientHeight>=t.scrollHeight-4;ee=new IntersectionObserver(b=>{for(const k of b)k.isIntersecting?i.add(k.target.id):i.delete(k.target.id);const A=n.find(k=>i.has(k.id));A?o(A.id):l()&&o(n[n.length-1].id)},{root:t,rootMargin:"0px 0px -72% 0px",threshold:0}),n.forEach(b=>ee.observe(b)),o(n[0].id);const p=()=>{l()&&o(n[n.length-1].id)};t.addEventListener("scroll",p,{passive:!0}),J={container:t,handler:p}}function xe(e){var a;(a=document.getElementById("article-reader"))==null||a.remove(),G.blur();const n=document.createElement("div");n.innerHTML=zt(e);const t=n.firstElementChild;ne.appendChild(t),t.scrollTop=0,Xt(t),window.location.pathname!==`/articles/${e}/`&&window.history.pushState(null,"",`/articles/${e}/`)}function Ge(){var e;ee==null||ee.disconnect(),ee=null,J==null||J.container.removeEventListener("scroll",J.handler),J=null,(e=document.getElementById("article-reader"))==null||e.remove(),window.location.pathname.startsWith("/articles/")&&window.history.pushState(null,"","/"),G==null||G.focus({preventScroll:!0})}function Ee(e){return`${window.location.origin}/articles/${e}/`}function Kt(e){const n=e.textContent;e.textContent="copied ✓",e.disabled=!0,window.setTimeout(()=>{e.textContent=n,e.disabled=!1},1500)}async function Ne(e,n){try{await navigator.clipboard.writeText(Ee(e)),Kt(n)}catch{window.prompt("Copy this link:",Ee(e))}}async function Zt(e,n){const t=Z.find(i=>i.slug===e),a=Ee(e);if(navigator.share){try{await navigator.share({title:(t==null?void 0:t.title)??e,url:a})}catch{}return}await Ne(e,n)}function Qt(){return`<div class="output-title">/utils</div>
<p class="prose">Useful free resources: books, courses, docs, and tools I keep coming back to.</p>
${it.map(e=>`<div class="utils-group">
...
<span class="label">location</span><span>${ke}</span></div>`}function en(){return`<div class="output-title">/games</div>
...
<div class="output-note">Games open fullscreen. Press <span class="key">Esc</span> to return.</div>`}function tn(){return`<div class="tree"><span class="blue">~</span>
...
└── <button class="inline-command directory" data-command="games">games/</button></div>`}function nn(){return`<div class="neofetch"><div class="neofetch-mark" aria-hidden="true">╭─────╮
│ A B │
│ L Z │
...
<span class="palette"><i></i><i></i><i></i><i></i><i></i><i></i></span></div></div>`}function on(){return'<div class="ls-output"><button class="inline-command file" data-command="about">about.txt</button><button class="inline-command directory" data-command="skills">skills/</button><button class="inline-command file" data-command="experience">experience.log</button><button class="inline-command directory" data-command="projects">projects/</button><button class="inline-command directory" data-command="brew">brew/</button><button class="inline-command directory" data-command="lab">lab/</button><button class="inline-command directory" data-command="articles">articles/</button><button class="inline-command directory" data-command="utils">utils/</button><button class="inline-command file" data-command="contact">contact.vcf</button><button class="inline-command directory" data-command="games">games/</button></div>'}function an(e){return He.map(n=>n.split("").map(t=>t===" "||Math.random()>=e?t:Oe[Math.floor(Math.random()*Oe.length)]).join("")).join(`
`)}function rn(){const e=document.createElement("div");e.className="output-block ascii-banner accent",te.appendChild(e);const n=6;let t=0;const a=window.setInterval(()=>{t+=1,e.textContent=t>=n?He.join(`
`):an(Math.max(0,.6-t*.12)),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight}),t>=n&&(window.clearInterval(a),Y('<span class="green">Purring in binary.</span>'))},90)}function ln(e){const n=document.createElement("div");n.className="output-block command-echo";const t=document.createElement("span");t.className="prompt",t.innerHTML=`<span class="prompt-user">${De}</span><span class="prompt-symbol">$</span>`;const a=document.createElement("span");a.textContent=e,n.append(t,a),te.appendChild(n)}function Y(e,n=""){const t=document.createElement("div");t.className=`output-block ${n}`.trim(),t.innerHTML=e,te.appendChild(t),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight})}function qe(e){const n=e.trim();if(!n)return;ln(n),re.at(-1)!==n&&re.push(n),ye=re.length;const[t,...a]=n.split(/\s+/),i=t.toLowerCase(),o=a.join(" ").toLowerCase();if(i==="clear"){te.replaceChildren();return}if(["about","whoami","cat"].includes(i)){i!=="cat"||!o||o==="about.txt"?Y(Ht()):o==="contact.vcf"?Y(ve()):o.endsWith(".md")&&de(o.slice(0,-3))?xe(o.slice(0,-3)):Y(`<span class="red">cat: ${fe(o)}: No such file</span>`);return}const l={help:Bt,skills:jt,experience:Gt,projects:Nt,brew:qt,lab:Ft,articles:Wt,utils:Qt,contact:ve,games:en,ls:on,tree:tn,neofetch:nn};if(l[i]){Y(l[i]());return}if(i==="cv"){ot(),Y('<span class="green">Downloading albertobarrago_cv.pdf…</span>');return}if(i==="history"){Y(re.map((p,b)=>`<div><span class="muted">${String(b+1).padStart(3," ")}</span>  ${fe(p)}</div>`).join(""));return}if(i==="date"){Y(new Intl.DateTimeFormat("it-IT",{dateStyle:"full",timeStyle:"long"}).format(new Date));return}if(i==="play"){sn(o)?(Y(`<span class="green">Launching ${be[o]}…</span>`),dn(o)):Y(`<span class="red">Unknown game${o?`: ${fe(o)}`:""}.</span> Try <button class="inline-command command" data-command="games">games</button>.`);return}if(i==="1337"){rn();return}if(i==="sudo"&&o==="hire alberto"){Y('<span class="green">Permission granted. Opening contact details…</span>'),Y(ve());return}Y(`<span class="red">command not found: ${fe(i)}</span><br>Type <button class="inline-command command" data-command="help">help</button> to see available commands.`)}function sn(e){return Object.hasOwn(Be,e)}function cn(e){const n=Pt[e].map(t=>`<button class="game-control-button" type="button" data-control-key="${t.key}">${t.label}</button>`).join("");return`<div class="game-fullscreen" id="game-overlay">
	...
	</div>`}function dn(e){we(),G.blur();const n=document.createElement("div");n.innerHTML=cn(e);const t=n.firstElementChild;ne.appendChild(t);const a=t.querySelector(".game-canvas");requestAnimationFrame(()=>{t.isConnected&&(ce=Be[e](a,we))})}function we(){var e;ce==null||ce(),ce=null,Fe(),(e=document.getElementById("game-overlay"))==null||e.remove(),G==null||G.focus({preventScroll:!0})}function Se(e,n){window.dispatchEvent(new KeyboardEvent(n,{key:e,bubbles:!0,cancelable:!0}))}function pn(e){var o;const t=e.target.closest("[data-control-key]"),a=t==null?void 0:t.dataset.controlKey;if(!t||!a)return;e.preventDefault(),(o=t.setPointerCapture)==null||o.call(t,e.pointerId);const i={key:a,button:t};pe.set(e.pointerId,i),t.classList.add("is-pressed"),Se(a,"keydown"),Ot.has(a)&&(i.delayId=window.setTimeout(()=>{i.intervalId=window.setInterval(()=>Se(a,"keydown"),85)},220))}function _e(e){const n=pe.get(e.pointerId);n&&(e.preventDefault(),n.delayId&&window.clearTimeout(n.delayId),n.intervalId&&window.clearInterval(n.intervalId),n.button.classList.remove("is-pressed"),pe.delete(e.pointerId),Se(n.key,"keyup"))}function Fe(){for(const e of pe.values())e.delayId&&window.clearTimeout(e.delayId),e.intervalId&&window.clearInterval(e.intervalId),e.button.classList.remove("is-pressed"),Se(e.key,"keyup");pe.clear()}ne.innerHTML=$t();const te=document.getElementById("terminal-output"),hn=document.getElementById("terminal-form"),G=document.getElementById("terminal-input");Y(Dt(),"welcome-block");gt();function We(){var e,n;return((e=window.location.pathname.match(/^\/articles\/([^/]+)\/?$/))==null?void 0:e[1])??((n=window.location.hash.match(/^#article\/(.+)$/))==null?void 0:n[1])}const Te=We();Te&&de(Te)&&xe(Te);window.addEventListener("popstate",()=>{var n;const e=We();e&&de(e)?xe(e):(n=document.getElementById("article-reader"))==null||n.remove()});hn.addEventListener("submit",e=>{e.preventDefault();const n=G.value;G.value="",qe(n)});G.addEventListener("keydown",e=>{if(e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const n=e.key==="ArrowUp"?-1:1;ye=Math.max(0,Math.min(re.length,ye+n)),G.value=re[ye]??"",requestAnimationFrame(()=>G.setSelectionRange(G.value.length,G.value.length));return}if(e.key==="Tab"){e.preventDefault();const n=G.value.trim().toLowerCase(),t=Rt.filter(a=>a.startsWith(n));t.length===1?G.value=t[0]:t.length>1&&Y(t.map(a=>`<span class="command">${a}</span>`).join("  "))}});ne.addEventListener("click",e=>{var b,A,k;const n=e.target,t=document.querySelector("#reader-toc.is-open");t&&!n.closest("#reader-toc")&&!n.closest('[data-action="toggle-toc"]')&&t.classList.remove("is-open");const a=n.closest('[data-action="read-article"]');if(a!=null&&a.dataset.slug){xe(a.dataset.slug);return}if(n.closest('[data-action="close-reader"]')){Ge();return}const i=n.closest('[data-action="share-article"]');if(i!=null&&i.dataset.slug){Zt(i.dataset.slug,i);return}const o=n.closest('[data-action="copy-article-link"]');if(o!=null&&o.dataset.slug){Ne(o.dataset.slug,o);return}if(n.closest('[data-action="toggle-toc"]')){(b=document.getElementById("reader-toc"))==null||b.classList.toggle("is-open");return}const l=n.closest('[data-action="goto-heading"]');if(l!=null&&l.dataset.target){const S=document.getElementById("article-reader");(A=document.getElementById(l.dataset.target))==null||A.scrollIntoView({behavior:"smooth",block:"start"}),(k=S==null?void 0:S.querySelector("#reader-toc"))==null||k.classList.remove("is-open");return}const p=n.closest("[data-command]");p!=null&&p.dataset.command&&qe(p.dataset.command),n.closest('[data-action="exit-game"]')&&we(),!n.closest("a")&&!document.getElementById("game-overlay")&&!document.getElementById("article-reader")&&G.focus({preventScroll:!0})});ne.addEventListener("pointerdown",pn);ne.addEventListener("pointerup",_e);ne.addEventListener("pointercancel",_e);ne.addEventListener("lostpointercapture",_e);window.addEventListener("blur",Fe);document.addEventListener("keydown",e=>{e.key==="Escape"&&document.getElementById("game-overlay")&&we(),e.key==="Escape"&&document.getElementById("article-reader")&&Ge()});
