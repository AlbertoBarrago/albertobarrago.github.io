(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Xe="4.6.0",Je={version:Xe},Ae="Alberto Barrago",Le="Senior Software Engineer",xe="Cagliari, Italy",Oe="albertobarrago@gmail.com",Ce="albertobarrago_cv.pdf",Ke="Senior Software Engineer with a product-builder mindset, turning ideas into scalable, production-ready tools that solve real-world problems.",Ze={frontend:["Angular","React","Vanilla JS"],backend:["Node.js","Fastify","FastAPI","Flask","Spring Boot"],apple:["Swift","SwiftUI","SwiftData","AppKit","iOS/macOS"],database:["MongoDB","Oracle","MySQL"],devops:["Docker","GitHub/GitLab CI","Azure DevOps"],tools:["Git","Neovim","tmux","Zed"],ai:["LLM Integration","Prompt Engineering","AI Agents"]},Qe=[{role:"Tech Leader / Senior Software Engineer",company:"C22 Consulting",period:"2026 - Present",highlight:"Leading React, iOS, and Java architecture across active projects; mentoring developers and evangelizing AI workflows with Claude and MCP"},{role:"Senior Software Engineer / DevOps",company:"Minsait/Indra",period:"2023 - 2025",highlight:"Angular component library for 6+ teams, DevOps ownership, CI/CD optimization -30% deploy time"},{role:"Senior Software Developer",company:"Softfobia",period:"2022 - 2023",highlight:"Led full-stack teams, 20% load time improvement"},{role:"Software Developer",company:"Accenture",period:"2021 - 2022",highlight:"Kafka microservices architecture, Angular 12 apps"},{role:"Software Developer",company:"Sinossi",period:"2016 - 2021",highlight:"Mobile apps for Deutsche Bank, TIM (Fortune 500)"}],et=[{name:"Markasso",description:"A fast, minimal, keyboard-first whiteboard engine for the browser. Marker + Picasso. No framework. No runtime. Just canvas.",url:"https://markasso.it",language:"TypeScript (0 deps)",status:"Experimental · Work in progress",focus:"Validating a direct, distraction-free interaction model for visual thinking."},{name:"Iron Doctrine",description:"A real-time strategy game with a deterministic ECS engine, running React + Pixi.js on the client, with lockstep online 1v1 multiplayer.",url:"https://iron-doctrine-omega.vercel.app/",language:"TypeScript (pnpm monorepo)",status:"Experimental · Work in progress",focus:"Deterministic simulation shared across local and networked play, driven by command replay."}],tt=[{name:"RSS-Reader",description:"A lightweight, native macOS RSS Reader app built with Swift. Lives in your menu bar: clean, minimal, no bloat.",url:"https://github.com/AlbertoBarrago/RSS-Reader",language:"Swift"},{name:"Timelog",description:"A lightweight time-tracking app for iOS and macOS built with SwiftUI and SwiftData.",url:"https://github.com/AlbertoBarrago/Timelog",language:"Swift"},{name:"DockDock",description:"A native macOS utility that shows live window previews when you hover over Dock icons.",url:"https://github.com/AlbertoBarrago/DockDock",language:"Swift"},{name:"Sgommello",description:"Break reminder for macOS: a monster breaks your screen until you take a real break.",url:"https://github.com/AlbertoBarrago/Sgommello",language:"Swift"}],nt=[{name:"wir",description:"What Is Running - Port and Process Inspector.",install:"brew install AlbertoBarrago/tap/wir",url:"https://github.com/AlbertoBarrago/wir",tap:"AlbertoBarrago/tap"},{name:"jm",description:"Switch between JDKs registered with macOS. Primary shell command: jm.",install:"brew install AlbertoBarrago/tap/jm",url:"https://github.com/AlbertoBarrago/jm",tap:"AlbertoBarrago/tap"},{name:"serval",description:"Local-first CLI that estimates the blast radius of a code change. Primary shell command: serval.",install:"brew install AlbertoBarrago/tap/serval",url:"https://github.com/AlbertoBarrago/serval",tap:"AlbertoBarrago/tap"},{name:"otelma",description:"A local LLM inference runtime, built from scratch in Go for Apple Silicon on top of llama.cpp. Smaller and more didactic than Ollama, with a configurable unified memory budget as an explicit constraint. v0.2.",install:"brew install AlbertoBarrago/tap/otelma",url:"https://github.com/AlbertoBarrago/otelma",tap:"AlbertoBarrago/tap"}],ge={github:"https://github.com/AlbertoBarrago",email:`mailto:${Oe}`,bsky:"https://bsky.app/profile/albzoser.bsky.social"},_e=Je.version,it=()=>{const e=document.createElement("a");e.href=Ce,e.download=Ce,e.dispatchEvent(new MouseEvent("click"))};function ot(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=8,i=5,o=32,r=24,p=12,b=40,A=20,x=3,S=12,l=5,M=7,q=4,V=.003,L=["#ff6b6b","#ff6b6b","#ffbd2e","#ffbd2e","#00ff41"],E=1e3/60;let m="waiting",y=0,$=3,_=parseInt(localStorage.getItem("spaceInvadersHigh")||"0",10),D=0,W=0,h=0,k=[],T=[],R=[];function s(){const c=e.width||e.clientWidth||1,g=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const w=e.width/c,U=e.height/g;h=Math.max(0,Math.min(e.width-b,h*w));for(const X of k)X.x*=w,X.y*=U;for(const X of T)X.x*=w,X.y*=U;for(const X of R)X.x*=w,X.y*=U;m!=="playing"&&(h=e.width/2-b/2)}s();const v=new ResizeObserver(s);v.observe(e);const O=()=>e.height-40;let I=1,f=0,H=40;const B=10,F=20;function C(){k=[];const c=a*(o+p)-p,g=(e.width-c)/2;for(let w=0;w<i;w++)for(let U=0;U<a;U++)k.push({x:g+U*(o+p),y:60+w*(r+p),row:w,alive:!0});I=1,f=0,H=40}let j=0;const z={};function K(c){if(c.key==="Escape"){n();return}(m==="waiting"||m==="gameover"||m==="won")&&c.key==="Enter"&&(m="playing",y=0,$=3,T=[],R=[],h=e.width/2-b/2,C()),z[c.key]=!0,(c.key===" "||c.key==="ArrowLeft"||c.key==="ArrowRight")&&c.preventDefault()}function se(c){z[c.key]=!1}window.addEventListener("keydown",K),window.addEventListener("keyup",se);function he(c){if(m==="playing"){z.ArrowLeft&&h>0&&(h-=l*c),z.ArrowRight&&h<e.width-b&&(h+=l*c),h=Math.max(0,Math.min(e.width-b,h)),j>0&&(j=Math.max(0,j-c)),z[" "]&&j===0&&(T.push({x:h+b/2-x/2,y:O()-S}),j=15);for(let g=T.length-1;g>=0;g--){if(T[g].y-=M*c,T[g].y<0){T.splice(g,1);continue}for(const w of k)if(w.alive&&T[g]&&T[g].x<w.x+o&&T[g].x+x>w.x&&T[g].y<w.y+r&&T[g].y+S>w.y){w.alive=!1,T.splice(g,1),y+=10,y>_&&(_=y,localStorage.setItem("spaceInvadersHigh",String(_)));const U=k.filter(X=>X.alive).length;U>0&&(H=Math.max(4,Math.floor(40*(U/(i*a)))));break}}if(k.every(g=>!g.alive)){m="won";return}if(f+=c,f>=H){f=0;let g=!1;for(const w of k)if(w.alive&&(I>0&&w.x+o+B>e.width-10||I<0&&w.x-B<10)){g=!0;break}if(g){I*=-1;for(const w of k)w.y+=F}else for(const w of k)w.x+=B*I;for(const w of k)if(w.alive&&w.y+r>=O()){m="gameover";return}}for(const g of k.filter(w=>w.alive))Math.random()<V*c&&R.push({x:g.x+o/2-x/2,y:g.y+r});for(let g=R.length-1;g>=0;g--){if(R[g].y+=q*c,R[g].y>e.height){R.splice(g,1);continue}if(R[g].x<h+b&&R[g].x+x>h&&R[g].y<O()+A&&R[g].y+S>O()&&(R.splice(g,1),$--,$<=0)){m="gameover";return}}}}function ue(){if(t){if(t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height),m==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("SPACE INVADERS",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrows = Move | Fire = Shoot",e.width/2,e.height/2+50),t.fillText("ESC = Exit | High Score: "+_,e.width/2,e.height/2+78),t.textAlign="left";return}t.fillStyle="#00bfff",t.beginPath(),t.moveTo(h+b/2,O()),t.lineTo(h,O()+A),t.lineTo(h+b,O()+A),t.closePath(),t.fill();for(const c of k)c.alive&&(t.fillStyle=L[c.row],t.fillRect(c.x+4,c.y,o-8,r-4),t.fillRect(c.x+2,c.y+4,6,4),t.fillRect(c.x+o-8,c.y+4,6,4),t.fillRect(c.x+6,c.y-4,3,6),t.fillRect(c.x+o-9,c.y-4,3,6),t.fillRect(c.x,c.y+r-6,4,6),t.fillRect(c.x+o-4,c.y+r-6,4,6));t.fillStyle="#00ff41";for(const c of T)t.fillRect(c.x,c.y,x,S);t.fillStyle="#ff6b6b";for(const c of R)t.fillRect(c.x,c.y,x,S);t.fillStyle="#00ff41",t.font="22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+y,10,24),t.textAlign="center",t.fillText("HIGH: "+_,e.width/2,24),t.textAlign="right",t.fillText("LIVES: "+"♥".repeat($),e.width-10,24),t.textAlign="left",m==="gameover"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+y,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left"),m==="won"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("YOU WIN!",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+y,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO PLAY AGAIN",e.width/2,e.height/2+60),t.textAlign="left")}}function me(c){W===0&&(W=c);const g=Math.min((c-W)/E,3);W=c,he(g),ue(),D=requestAnimationFrame(me)}return C(),D=requestAnimationFrame(me),function(){cancelAnimationFrame(D),window.removeEventListener("keydown",K),window.removeEventListener("keyup",se),v.disconnect()}}const ae=10,re=20,Pe=[{shape:[[1,1,1,1]],color:"#00bfff"},{shape:[[1,1],[1,1]],color:"#ffbd2e"},{shape:[[0,1,0],[1,1,1]],color:"#a855f7"},{shape:[[1,0,0],[1,1,1]],color:"#ff6b6b"},{shape:[[0,0,1],[1,1,1]],color:"#00ff41"},{shape:[[0,1,1],[1,1,0]],color:"#ff6b6b"},{shape:[[1,1,0],[0,1,1]],color:"#00ff41"}];function at(){const e=[];for(let n=0;n<re;n++)e.push(new Array(ae).fill(null));return e}function lt(e,n,t,a){for(let i=0;i<n.length;i++)for(let o=0;o<n[i].length;o++){if(!n[i][o])continue;const r=t+o,p=a+i;if(r<0||r>=ae||p>=re||p>=0&&e[p][r])return!0}return!1}function rt(e){const n=e.length,t=e[0].length,a=[];for(let i=0;i<t;i++){a.push([]);for(let o=n-1;o>=0;o--)a[i].push(e[o][i])}return a}function st(e){let n=0;for(let t=re-1;t>=0;t--)e[t].every(a=>a!==null)&&(e.splice(t,1),e.unshift(new Array(ae).fill(null)),n++,t++);return n}function ct(e,n){return e<=0?0:([0,100,300,500,800][e]||800)*n}function dt(e){const n=Math.floor(e/10)+1,t=Math.max(5,45-(n-1)*4);return{level:n,dropInterval:t}}function pt(e,n){const t=e.getContext("2d");if(!t)return()=>{};let a="waiting",i=0,o=1,r=0,p=parseInt(localStorage.getItem("tetrisHigh")||"0",10),b=0,A=0;const x=1e3/60;let S=[],l=null,M=0,q=45;function V(){e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight)}V();const L=new ResizeObserver(V);L.observe(e);function E(){S=at()}function m(s,v,O){return lt(S,s,v,O)}function y(){const s=Pe[Math.floor(Math.random()*Pe.length)];l={shape:s.shape.map(v=>[...v]),color:s.color,x:Math.floor((ae-s.shape[0].length)/2),y:0},m(l.shape,l.x,l.y)&&(a="gameover",l=null)}function $(){if(l){for(let s=0;s<l.shape.length;s++)for(let v=0;v<l.shape[s].length;v++){if(!l.shape[s][v])continue;const O=l.y+s;O>=0&&(S[O][l.x+v]=l.color)}_(),y()}}function _(){const s=st(S);s>0&&(i+=ct(s,o),r+=s,{level:o,dropInterval:q}=dt(r),i>p&&(p=i,localStorage.setItem("tetrisHigh",String(p))))}const D={};function W(s){if(s.key==="Escape"){n();return}if((a==="waiting"||a==="gameover")&&s.key==="Enter"&&(a="playing",i=0,o=1,r=0,q=45,E(),y()),a!=="playing"||!l){D[s.key]=!0;return}if(s.key==="ArrowLeft")m(l.shape,l.x-1,l.y)||l.x--;else if(s.key==="ArrowRight")m(l.shape,l.x+1,l.y)||l.x++;else if(s.key==="ArrowDown")m(l.shape,l.x,l.y+1)?$():l.y++;else if(s.key==="ArrowUp"||s.key===" "){const v=rt(l.shape);m(v,l.x,l.y)?m(v,l.x-1,l.y)?m(v,l.x+1,l.y)||(l.shape=v,l.x++):(l.shape=v,l.x--):l.shape=v}D[s.key]=!0,["ArrowLeft","ArrowRight","ArrowDown","ArrowUp"," "].includes(s.key)&&s.preventDefault()}function h(s){D[s.key]=!1}window.addEventListener("keydown",W),window.addEventListener("keyup",h);function k(s){a!=="playing"||!l||(M+=s,M>=q&&(M=0,m(l.shape,l.x,l.y+1)?$():l.y++))}function T(){if(!t)return;t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height);const s=e.width<520,v=s?20:200,O=s?96:60,I=Math.max(8,Math.min(Math.floor((e.height-O)/re),Math.floor((e.width-v)/ae))),f=I*ae,H=I*re,B=Math.floor((e.width-f)/2),F=Math.max(s?68:36,Math.floor((e.height-H)/2)+10);if(a==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("TETRIS",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrows = Move | Up/Space = Rotate",e.width/2,e.height/2+50),t.fillText("ESC = Exit | High Score: "+p,e.width/2,e.height/2+78),t.textAlign="left";return}t.strokeStyle="#333",t.lineWidth=2,t.strokeRect(B-1,F-1,f+2,H+2);for(let C=0;C<re;C++)for(let j=0;j<ae;j++){const z=B+j*I,K=F+C*I;S[C][j]?(t.fillStyle=S[C][j],t.fillRect(z+1,K+1,I-2,I-2)):(t.fillStyle="#111",t.fillRect(z,K,I,I),t.strokeStyle="#1a1a1a",t.lineWidth=.5,t.strokeRect(z,K,I,I))}if(l){t.fillStyle=l.color;for(let C=0;C<l.shape.length;C++)for(let j=0;j<l.shape[C].length;j++){if(!l.shape[C][j])continue;const z=B+(l.x+j)*I,K=F+(l.y+C)*I;t.fillRect(z+1,K+1,I-2,I-2)}}t.fillStyle="#00ff41",t.font=s?"18px VT323, monospace":"22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+i,10,24),t.fillText("LEVEL: "+o,10,s?46:50),t.textAlign="center",t.fillText("HIGH: "+p,e.width/2,24),t.textAlign="right",t.fillText("LINES: "+r,e.width-10,24),t.textAlign="left",a==="gameover"&&(t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+i+"  Lines: "+r,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left")}function R(s){A===0&&(A=s);const v=Math.min((s-A)/x,3);A=s,k(v),T(),b=requestAnimationFrame(R)}return E(),b=requestAnimationFrame(R),function(){cancelAnimationFrame(b),window.removeEventListener("keydown",W),window.removeEventListener("keyup",h),L.disconnect()}}function ht(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=12,i=80,o=10,r=5,p=4,b=3.5,A=7,x=1e3/60;let S="waiting",l=0,M=0,q=0,V=0,L=0,E=0,m=0,y=0,$=p,_=p*.5;function D(){const f=e.width||e.clientWidth||1,H=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const B=e.width/f,F=e.height/H;L=Math.max(0,Math.min(e.height-i,L*F)),E=Math.max(0,Math.min(e.height-i,E*F)),m=Math.max(0,Math.min(e.width-o,m*B)),y=Math.max(0,Math.min(e.height-o,y*F)),S!=="playing"&&(L=e.height/2-i/2,E=e.height/2-i/2,m=e.width/2,y=e.height/2)}D();const W=new ResizeObserver(D);W.observe(e);function h(){m=e.width/2,y=e.height/2,$=p*(Math.random()>.5?1:-1),_=(Math.random()*2-1)*p*.5}const k={};function T(f){if(f.key==="Escape"){n();return}(S==="waiting"||S==="gameover")&&f.key==="Enter"&&(S="playing",l=0,M=0,L=e.height/2-i/2,E=e.height/2-i/2,h()),k[f.key]=!0,(f.key==="ArrowUp"||f.key==="ArrowDown")&&f.preventDefault()}function R(f){k[f.key]=!1}window.addEventListener("keydown",T),window.addEventListener("keyup",R);function s(f){if(S!=="playing")return;const H=e.getBoundingClientRect(),B=f.clientY-H.top;L=Math.max(0,Math.min(e.height-i,B-i/2)),f.preventDefault()}e.addEventListener("pointerdown",s),e.addEventListener("pointermove",s);function v(f){if(S!=="playing")return;k.ArrowUp&&L>0&&(L-=r*f),k.ArrowDown&&L<e.height-i&&(L+=r*f),L=Math.max(0,Math.min(e.height-i,L));const H=E+i/2;$>0?H<y-10?E+=b*f:H>y+10&&(E-=b*f):H<e.height/2-5?E+=b*.5*f:H>e.height/2+5&&(E-=b*.5*f),E=Math.max(0,Math.min(e.height-i,E)),m+=$*f,y+=_*f,y<=0&&(y=0,_=Math.abs(_)),y+o>=e.height&&(y=e.height-o,_=-Math.abs(_));const B=20;m<=B+a&&m+o>=B&&y+o>=L&&y<=L+i&&$<0&&($=Math.abs($)*1.05,_=((y+o/2-L)/i-.5)*p*2,m=B+a);const F=e.width-20-a;m+o>=F&&m<=F+a&&y+o>=E&&y<=E+i&&$>0&&($=-Math.abs($)*1.05,_=((y+o/2-E)/i-.5)*p*2,m=F-o),m<0&&(M++,M>=A?S="gameover":h()),m>e.width&&(l++,l>=A?S="gameover":h())}function O(){if(t){if(t.fillStyle="#0a0a0a",t.fillRect(0,0,e.width,e.height),S==="waiting"){t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("PONG",e.width/2,e.height/2-60),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS ENTER TO START",e.width/2,e.height/2+10),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Arrow Up/Down or Drag = Move",e.width/2,e.height/2+50),t.fillText("First to "+A+" wins | ESC = Exit",e.width/2,e.height/2+78),t.textAlign="left";return}if(t.setLineDash([8,8]),t.strokeStyle="#333",t.lineWidth=2,t.beginPath(),t.moveTo(e.width/2,0),t.lineTo(e.width/2,e.height),t.stroke(),t.setLineDash([]),t.fillStyle="#00ff41",t.fillRect(20,L,a,i),t.fillStyle="#ff6b6b",t.fillRect(e.width-20-a,E,a,i),t.fillStyle="#ffbd2e",t.fillRect(m,y,o,o),t.fillStyle="#00ff41",t.font="48px VT323, monospace",t.textAlign="center",t.fillText(String(l),e.width/2-60,55),t.fillStyle="#ff6b6b",t.fillText(String(M),e.width/2+60,55),t.textAlign="left",t.font="18px VT323, monospace",t.fillStyle="#888",t.textAlign="left",t.fillText("YOU",20,e.height-15),t.textAlign="right",t.fillText("CPU",e.width-20,e.height-15),t.textAlign="left",S==="gameover"){t.fillStyle="rgba(0,0,0,0.7)",t.fillRect(0,0,e.width,e.height);const f=l>=A;t.fillStyle=f?"#00ff41":"#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText(f?"YOU WIN!":"CPU WINS",e.width/2,e.height/2-20),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText(l+" - "+M,e.width/2,e.height/2+20),t.fillStyle="#888",t.fillText("PRESS ENTER TO RESTART",e.width/2,e.height/2+60),t.textAlign="left"}}}function I(f){V===0&&(V=f);const H=Math.min((f-V)/x,3);V=f,v(H),O(),q=requestAnimationFrame(I)}return q=requestAnimationFrame(I),function(){cancelAnimationFrame(q),window.removeEventListener("keydown",T),window.removeEventListener("keyup",R),e.removeEventListener("pointerdown",s),e.removeEventListener("pointermove",s),W.disconnect()}}function ut(e,n){const t=e.getContext("2d");if(!t)return()=>{};const a=24,i=.34,o=-6.6,r=58,p=168,b=2.15,A=126,x=46,S=1e3/60,l=100;let M="waiting",q=0,V=parseInt(localStorage.getItem("flappyBirdHigh")||"0",10),L=0,E=0,m=0,y=0,$=A,_=0,D=0,W=0,h=null,k=null,T=[];function R(){const d=e.width||e.clientWidth||1,u=e.height||e.clientHeight||1;e.width=Math.max(1,e.clientWidth),e.height=Math.max(1,e.clientHeight);const N=e.width/d,Q=e.height/u;for(const P of T)P.x*=N,P.gapY=I(P.gapY*Q);M!=="playing"?v():(_=Math.max(50,Math.min(e.width-30,_*N)),D=Math.max(a,Math.min(e.height-x-a,D*Q)))}R();const s=new ResizeObserver(R);s.observe(e);function v(){_=Math.max(80,Math.floor(e.width*.28)),D=Math.floor(e.height*.45),W=0}function O(){const d=Math.max(160,e.height-x);return Math.max(86,Math.min(p,d-112))}function I(d){const u=O(),N=56,Q=Math.max(N,e.height-x-u-48);return Math.max(N,Math.min(Q,d))}function f(){M="playing",q=0,y=0,m=0,$=A,T=[],v(),H(),j()}function H(){const u=Math.max(68,e.height-x-O()-48),N=56+Math.random()*(u-56);T.push({x:e.width+20,gapY:N,passed:!1})}function B(){if(F(),M==="waiting"||M==="gameover"){f();return}M==="playing"&&(W=o,z())}function F(){if(h){h.state==="suspended"&&h.resume();return}const d=globalThis.AudioContext??globalThis.webkitAudioContext;h=new d,k=h.createGain(),k.gain.value=.16,k.connect(h.destination)}function C(d,u,N="square",Q=.2){if(!h||!k)return;const P=h.currentTime,ie=h.createOscillator(),oe=h.createGain();ie.type=N,ie.frequency.setValueAtTime(d,P),oe.gain.setValueAtTime(1e-4,P),oe.gain.exponentialRampToValueAtTime(Q,P+.01),oe.gain.exponentialRampToValueAtTime(1e-4,P+u),ie.connect(oe),oe.connect(k),ie.start(P),ie.stop(P+u+.02)}function j(){C(440,.08,"square",.14),h&&setTimeout(()=>C(660,.08,"square",.12),65)}function z(){C(720,.06,"square",.11)}function K(){C(880,.07,"triangle",.14),setTimeout(()=>C(1175,.08,"triangle",.12),60)}function se(){if(!h||!k)return;const d=h.currentTime,u=h.createOscillator(),N=h.createGain();u.type="sawtooth",u.frequency.setValueAtTime(190,d),u.frequency.exponentialRampToValueAtTime(60,d+.22),N.gain.setValueAtTime(.22,d),N.gain.exponentialRampToValueAtTime(1e-4,d+.24),u.connect(N),N.connect(k),u.start(d),u.stop(d+.26)}function he(d){if(d.key==="Escape"){n();return}(d.key==="Enter"||d.key===" ")&&(B(),d.preventDefault())}function ue(){B()}window.addEventListener("keydown",he),e.addEventListener("pointerdown",ue);function me(){if(M!=="playing")return;for(y++,W+=i,D+=W;y>=$;)H(),$+=A;for(const P of T)P.x-=b,!P.passed&&P.x+r<_&&(P.passed=!0,q++,K(),q>V&&(V=q,localStorage.setItem("flappyBirdHigh",String(V))));T=T.filter(P=>P.x+r>-20);const d=_-a/2,u=_+a/2,N=D-a/2,Q=D+a/2;if(N<=0||Q>=e.height-x){M="gameover",se();return}for(const P of T){const ie=u>P.x&&d<P.x+r,oe=N<P.gapY,Ue=Q>P.gapY+O();if(ie&&(oe||Ue)){M="gameover",se();return}}}function c(){const d=t.createLinearGradient(0,0,0,e.height);d.addColorStop(0,"#082238"),d.addColorStop(1,"#071014"),t.fillStyle=d,t.fillRect(0,0,e.width,e.height),t.fillStyle="rgba(0, 255, 65, 0.08)";for(let u=y*-.3%90;u<e.width;u+=90)t.fillRect(u,80,34,8),t.fillRect(u+8,72,18,8)}function g(){const d=O();for(const u of T)t.fillStyle="#00a33a",t.fillRect(u.x,0,r,u.gapY),t.fillRect(u.x,u.gapY+d,r,e.height-x-u.gapY-d),t.fillStyle="#00ff41",t.fillRect(u.x-4,u.gapY-14,r+8,14),t.fillRect(u.x-4,u.gapY+d,r+8,14),t.fillStyle="rgba(0,0,0,0.22)",t.fillRect(u.x+r-12,0,6,u.gapY-14),t.fillRect(u.x+r-12,u.gapY+d+14,6,e.height-x)}function w(){const d=e.height-x;t.fillStyle="#332211",t.fillRect(0,d,e.width,x),t.fillStyle="#ffbd2e",t.fillRect(0,d,e.width,4),t.fillStyle="rgba(0, 255, 65, 0.35)";for(let u=y*-b%28;u<e.width;u+=28)t.fillRect(u,d+10,14,4)}function U(){const d=Math.max(-.45,Math.min(.7,W/12));t.save(),t.translate(_,D),t.rotate(d),t.fillStyle="#ffbd2e",t.fillRect(-12,-10,22,20),t.fillStyle="#ffe680",t.fillRect(-16,-2,14,10),t.fillStyle="#ff6b6b",t.fillRect(8,-2,12,6),t.fillStyle="#fff",t.fillRect(2,-8,6,6),t.fillStyle="#0a0a0a",t.fillRect(6,-6,2,2),t.restore()}function X(){t.fillStyle="#00ff41",t.font="22px VT323, monospace",t.textAlign="left",t.fillText("SCORE: "+q,10,24),t.textAlign="center",t.fillText("HIGH: "+V,e.width/2,24),t.textAlign="right",t.fillText("SPACE = FLAP",e.width-10,24),t.textAlign="left"}function Fe(){t.fillStyle="rgba(0,0,0,0.45)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#00ff41",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("FLAPPY BIRD",e.width/2,e.height/2-70),t.font="24px VT323, monospace",t.fillStyle="#ffbd2e",t.fillText("PRESS SPACE OR CLICK TO START",e.width/2,e.height/2),t.fillStyle="#888",t.font="18px VT323, monospace",t.fillText("Space/Click = Flap",e.width/2,e.height/2+40),t.fillText("ESC = Exit | High Score: "+V,e.width/2,e.height/2+70),t.textAlign="left"}function Ye(){t.fillStyle="rgba(0,0,0,0.68)",t.fillRect(0,0,e.width,e.height),t.fillStyle="#ff6b6b",t.textAlign="center",t.font="48px VT323, monospace",t.fillText("GAME OVER",e.width/2,e.height/2-30),t.fillStyle="#ffbd2e",t.font="24px VT323, monospace",t.fillText("Score: "+q,e.width/2,e.height/2+10),t.fillStyle="#888",t.fillText("PRESS SPACE OR CLICK TO RESTART",e.width/2,e.height/2+50),t.textAlign="left"}function ze(){c(),g(),w(),U(),X(),M==="waiting"&&Fe(),M==="gameover"&&Ye()}function Re(d){E===0&&(E=d);const u=Math.min(d-E,l);for(E=d,m+=u;m>=S;)me(),m-=S;ze(),L=requestAnimationFrame(Re)}return v(),L=requestAnimationFrame(Re),function(){cancelAnimationFrame(L),window.removeEventListener("keydown",he),e.removeEventListener("pointerdown",ue),s.disconnect(),h==null||h.close(),h=null,k=null}}const mt=Object.freeze({"--background":"#0b0f14","--background-deep":"#070a0e","--surface":"#111820","--foreground":"#b8c4d4","--bright":"#e7edf5","--muted":"#667485","--border":"#22303d","--cyan":"#5eead4","--blue":"#7aa2f7","--green":"#9ece6a","--yellow":"#e0af68","--purple":"#bb9af7","--red":"#f7768e"});function ft(){console.log(`%c    _    _     ____   _____
   / \\  | |   | __ ) |__  /
  / _ \\ | |   |  _ \\   / /
 / ___ \\| |___| |_) | / /_
...
> say hi: %s
> code: %s`,"color: #b8c4d4; font-family: monospace;",Oe,ge.github),console.log("%csteal the theme (dark CRT terminal palette):","color: #e0af68; font-family: monospace;"),console.log(Object.entries(mt).map(([n,t])=>`${n}: ${t};`).join(`
...
`,bt=Object.freeze(Object.defineProperty({__proto__:null,html:yt,meta:gt},Symbol.toStringTag,{value:"Module"})),wt={title:"I Built a CLI to Answer One Question: What Will This Change Break?",date:"2026-08-27",tags:["programming","devops","go","opensource"]},St=`<p>We&#39;ve all been there.</p>
...
`,xt=Object.freeze(Object.defineProperty({__proto__:null,html:St,meta:wt},Symbol.toStringTag,{value:"Module"})),kt={title:"wir — What Is Running, a Port and Process Inspector Written in C",date:"2025-12-30",tags:["c","systems-programming","cli","opensource"]},Tt=`<p>I recently released <strong>wir</strong> (What Is Running), a command-line tool written in C to inspect what&#39;s running on specific ports and get detailed process information. A project born from a practical need that turned into an opportunity to explore system programming in C.</p>
<h2>The Problem</h2>
...
`,vt=Object.freeze(Object.defineProperty({__proto__:null,html:Tt,meta:kt},Symbol.toStringTag,{value:"Module"}));function At(e){return[...e].sort((n,t)=>n.date.localeCompare(t.date))}const Et=Object.assign({"/src/content/articles/iron-doctrine.md":bt,"/src/content/articles/serval-cli.md":xt,"/src/content/articles/wir-what-is-running.md":vt}),Ee=new Map,Z=At(Object.entries(Et).map(([e,n])=>{const t=e.split("/").pop().replace(/\.md$/,"");return Ee.set(t,n.html),{slug:t,title:n.meta.title??t,date:n.meta.date??"",tags:n.meta.tags??[]}}));function de(e){return Ee.has(e)?Ee.get(e):null}const He="alberto@portfolio:~",It=Object.freeze(["help","about","skills","experience","projects","brew","lab","articles","contact","cv","games","play","ls","tree","neofetch","history","date","clear"]),Lt=Object.freeze([["help","help"],["about","about"],["skills","skills"],["projects","projects"],["brew","brew"],["lab","lab"],["articles","articles"],["games","games"],["contact","contact"]]),be=Object.freeze({space:"SPACE INVADERS",tetris:"TETRIS",pong:"PONG",flappy:"FLAPPY BIRD"}),_t=Object.freeze({space:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"FIRE",key:" "},{label:"→",key:"ArrowRight"}],tetris:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"ROT",key:"ArrowUp"},{label:"→",key:"ArrowRight"},{label:"↓",key:"ArrowDown"}],pong:[{label:"START",key:"Enter"},{label:"↑",key:"ArrowUp"},{label:"↓",key:"ArrowDown"}],flappy:[{label:"START",key:"Enter"},{label:"FLAP",key:" "}]}),De=Object.freeze({space:ot,tetris:pt,pong:ht,flappy:ut}),Be=Object.freeze(["        /\\_/\\","       ( o.o )","        > ^ <","       /|   |\\","      (_|   |_)","         W W","","      I LOVE CAT"]),$e="#%@*+=-<>/\\|",Mt=new Set(["ArrowLeft","ArrowRight","ArrowDown"]),pe=new Map,le=[];let ye=0,ce=null,ee=null,J=null;const ne=document.getElementById("app");function Rt(){const e=Lt.map(([n,t])=>`<button class="mobile-command" type="button" data-command="${t}">${n}</button>`).join("");return`<main class="terminal" aria-label="Alberto Barrago portfolio terminal">
	...
	<div class="crt-overlay" aria-hidden="true"></div>`}function Ct(){return`<div class="ascii-banner accent" role="img" aria-label="ALBZ">    _    _     ____   _____
   / \\  | |   | __ ) |__  /
  / _ \\ | |   |  _ \\   / /
 / ___ \\| |___| |_) | / /_
...
Type <button class="inline-command command" data-command="help">help</button> to explore, or use the shortcuts below.</div>`}function Pt(){return`<div class="output-title">Available commands</div>
...
<div class="output-note">Tip: press <span class="key">Tab</span> to autocomplete and <span class="key">↑</span>/<span class="key">↓</span> for history.</div>`}function $t(){return`<div class="output-title">${Ae}</div>
...
<p class="prose">${Ke}</p>
<div class="output-links"><button class="inline-command command" data-command="projects">view projects</button><button class="inline-command command" data-command="contact">contact me</button><button class="inline-command command" data-command="cv">download cv</button></div>`}function Ot(){return`<div class="output-title">Technical toolbox</div>
<div class="skills-list">${Object.entries(Ze).map(([e,n])=>`<div class="skill-row"><span class="label">${e}</span><span>${n.join("  ·  ")}</span></div>`).join("")}</div>`}function Ht(){return`<div class="output-title">Experience</div>
<div class="timeline">${Qe.map(e=>`<article class="timeline-item">
	...
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function Dt(){return`<div class="output-title">Selected projects</div>
<div class="project-list">${tt.map(e=>`<article class="project-item">
	...
	<p>${e.description}</p>
</article>`).join("")}</div>`}function Bt(){return`<div class="output-title">Homebrew formulae</div>
...
</article>`).join("")}`}function je(e){if(!e)return e;const n=new Date(`${e}T00:00:00`);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("it-IT",{day:"2-digit",month:"2-digit",year:"numeric"}).format(n)}function Gt(){return Z.length===0?`<div class="output-title">Articles</div>
...
<div class="project-list">${[...Z].sort((n,t)=>n.date.localeCompare(t.date)).map(n=>`<article class="project-item">
...
</article>`).join("")}</div>`}const Nt=200;function qt(e){const n=e.replace(/<[^>]*>/g," ").replace(/\s+/g," ").trim(),t=n?n.split(" ").length:0;return{words:t,chars:n.length,minutes:Math.max(1,Math.round(t/Nt))}}function Wt(e){const n=Z.findIndex(p=>p.slug===e),t=Z[n],a=qt(de(e)??""),i=Z[n-1],o=Z[n+1],r=[i?`<button class="reader-nav-link" type="button" data-action="read-article" data-slug="${i.slug}">← ${i.title}</button>`:"<span></span>",o?`<button class="reader-nav-link reader-nav-next" type="button" data-action="read-article" data-slug="${o.slug}">${o.title} →</button>`:"<span></span>"].join("");return`<div class="article-reader" id="article-reader">
	...
	</div>`}function Vt(e){return e.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}function Ft(e){const n=e.querySelector("#reader-toc"),t=e.querySelectorAll(".prose h2, .prose h3");if(t.length===0)return;const a=new Set,i=Array.from(t).map(r=>{let p=Vt(r.textContent??"");for(;a.has(p)||!p;)p=`${p||"section"}-${a.size+1}`;return a.add(p),r.id=p,{id:p,text:r.textContent??"",level:r.tagName==="H2"?2:3}});n.innerHTML=`<span class="reader-toc-title">chapters</span><ol class="reader-toc-list">${i.map(r=>`<li class="reader-toc-item level-${r.level}"><button class="reader-toc-link" type="button" data-action="goto-heading" data-target="${r.id}">${r.text}</button></li>`).join("")}</ol>`,n.hidden=!1,e.classList.add("has-toc");const o=e.querySelector("#reader-toc-toggle");o&&(o.hidden=!1),Yt(e,Array.from(t))}function Yt(e,n){ee==null||ee.disconnect(),J==null||J.container.removeEventListener("scroll",J.handler),J=null;const t=e.querySelector(".article-reader-body"),a=e.querySelectorAll(".reader-toc-link"),i=new Set,o=b=>{a.forEach(A=>A.classList.toggle("is-active",A.dataset.target===b))},r=()=>t.scrollTop+t.clientHeight>=t.scrollHeight-4;ee=new IntersectionObserver(b=>{for(const x of b)x.isIntersecting?i.add(x.target.id):i.delete(x.target.id);const A=n.find(x=>i.has(x.id));A?o(A.id):r()&&o(n[n.length-1].id)},{root:t,rootMargin:"0px 0px -72% 0px",threshold:0}),n.forEach(b=>ee.observe(b)),o(n[0].id);const p=()=>{r()&&o(n[n.length-1].id)};t.addEventListener("scroll",p,{passive:!0}),J={container:t,handler:p}}function ke(e){var a;(a=document.getElementById("article-reader"))==null||a.remove(),G.blur();const n=document.createElement("div");n.innerHTML=Wt(e);const t=n.firstElementChild;ne.appendChild(t),t.scrollTop=0,Ft(t),window.location.pathname!==`/articles/${e}/`&&window.history.pushState(null,"",`/articles/${e}/`)}function Ge(){var e;ee==null||ee.disconnect(),ee=null,J==null||J.container.removeEventListener("scroll",J.handler),J=null,(e=document.getElementById("article-reader"))==null||e.remove(),window.location.pathname.startsWith("/articles/")&&window.history.pushState(null,"","/"),G==null||G.focus({preventScroll:!0})}function Ie(e){return`${window.location.origin}/articles/${e}/`}function zt(e){const n=e.textContent;e.textContent="copied ✓",e.disabled=!0,window.setTimeout(()=>{e.textContent=n,e.disabled=!1},1500)}async function Ne(e,n){try{await navigator.clipboard.writeText(Ie(e)),zt(n)}catch{window.prompt("Copy this link:",Ie(e))}}async function Ut(e,n){const t=Z.find(i=>i.slug===e),a=Ie(e);if(navigator.share){try{await navigator.share({title:(t==null?void 0:t.title)??e,url:a})}catch{}return}await Ne(e,n)}function Te(){return`<div class="output-title">Let's build something useful</div>
...
<span class="label">location</span><span>${xe}</span></div>`}function Xt(){return`<div class="output-title">/games</div>
...
└── <button class="inline-command directory" data-command="games">games/</button></div>`}function Kt(){return`<div class="neofetch"><div class="neofetch-mark" aria-hidden="true">╭─────╮
│ A B │
│ L Z │
...
<span class="palette"><i></i><i></i><i></i><i></i><i></i><i></i></span></div></div>`}function Zt(){return'<div class="ls-output"><button class="inline-command file" data-command="about">about.txt</button><button class="inline-command directory" data-command="skills">skills/</button><button class="inline-command file" data-command="experience">experience.log</button><button class="inline-command directory" data-command="projects">projects/</button><button class="inline-command directory" data-command="brew">brew/</button><button class="inline-command directory" data-command="lab">lab/</button><button class="inline-command directory" data-command="articles">articles/</button><button class="inline-command file" data-command="contact">contact.vcf</button><button class="inline-command directory" data-command="games">games/</button></div>'}function Qt(e){return Be.map(n=>n.split("").map(t=>t===" "||Math.random()>=e?t:$e[Math.floor(Math.random()*$e.length)]).join("")).join(`
`)}function en(){const e=document.createElement("div");e.className="output-block ascii-banner accent",te.appendChild(e);const n=6;let t=0;const a=window.setInterval(()=>{t+=1,e.textContent=t>=n?Be.join(`
`):Qt(Math.max(0,.6-t*.12)),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight}),t>=n&&(window.clearInterval(a),Y('<span class="green">Purring in binary.</span>'))},90)}function tn(e){const n=document.createElement("div");n.className="output-block command-echo";const t=document.createElement("span");t.className="prompt",t.innerHTML=`<span class="prompt-user">${He}</span><span class="prompt-symbol">$</span>`;const a=document.createElement("span");a.textContent=e,n.append(t,a),te.appendChild(n)}function Y(e,n=""){const t=document.createElement("div");t.className=`output-block ${n}`.trim(),t.innerHTML=e,te.appendChild(t),requestAnimationFrame(()=>{te.scrollTop=te.scrollHeight})}function qe(e){const n=e.trim();if(!n)return;tn(n),le.at(-1)!==n&&le.push(n),ye=le.length;const[t,...a]=n.split(/\s+/),i=t.toLowerCase(),o=a.join(" ").toLowerCase();if(i==="clear"){te.replaceChildren();return}if(["about","whoami","cat"].includes(i)){i!=="cat"||!o||o==="about.txt"?Y($t()):o==="contact.vcf"?Y(Te()):o.endsWith(".md")&&de(o.slice(0,-3))?ke(o.slice(0,-3)):Y(`<span class="red">cat: ${fe(o)}: No such file</span>`);return}const r={help:Pt,skills:Ot,experience:Ht,projects:Dt,brew:Bt,lab:jt,articles:Gt,contact:Te,games:Xt,ls:Zt,tree:Jt,neofetch:Kt};if(r[i]){Y(r[i]());return}if(i==="cv"){it(),Y('<span class="green">Downloading albertobarrago_cv.pdf…</span>');return}if(i==="history"){Y(le.map((p,b)=>`<div><span class="muted">${String(b+1).padStart(3," ")}</span>  ${fe(p)}</div>`).join(""));return}if(i==="date"){Y(new Intl.DateTimeFormat("it-IT",{dateStyle:"full",timeStyle:"long"}).format(new Date));return}if(i==="play"){nn(o)?(Y(`<span class="green">Launching ${be[o]}…</span>`),an(o)):Y(`<span class="red">Unknown game${o?`: ${fe(o)}`:""}.</span> Try <button class="inline-command command" data-command="games">games</button>.`);return}if(i==="1337"){en();return}if(i==="sudo"&&o==="hire alberto"){Y('<span class="green">Permission granted. Opening contact details…</span>'),Y(Te());return}Y(`<span class="red">command not found: ${fe(i)}</span><br>Type <button class="inline-command command" data-command="help">help</button> to see available commands.`)}function nn(e){return Object.hasOwn(De,e)}function on(e){const n=_t[e].map(t=>`<button class="game-control-button" type="button" data-control-key="${t.key}">${t.label}</button>`).join("");return`<div class="game-fullscreen" id="game-overlay">
	...
	</div>`}function an(e){we(),G.blur();const n=document.createElement("div");n.innerHTML=on(e);const t=n.firstElementChild;ne.appendChild(t);const a=t.querySelector(".game-canvas");requestAnimationFrame(()=>{t.isConnected&&(ce=De[e](a,we))})}function we(){var e;ce==null||ce(),ce=null,We(),(e=document.getElementById("game-overlay"))==null||e.remove(),G==null||G.focus({preventScroll:!0})}function Se(e,n){window.dispatchEvent(new KeyboardEvent(n,{key:e,bubbles:!0,cancelable:!0}))}function ln(e){var o;const t=e.target.closest("[data-control-key]"),a=t==null?void 0:t.dataset.controlKey;if(!t||!a)return;e.preventDefault(),(o=t.setPointerCapture)==null||o.call(t,e.pointerId);const i={key:a,button:t};pe.set(e.pointerId,i),t.classList.add("is-pressed"),Se(a,"keydown"),Mt.has(a)&&(i.delayId=window.setTimeout(()=>{i.intervalId=window.setInterval(()=>Se(a,"keydown"),85)},220))}function Me(e){const n=pe.get(e.pointerId);n&&(e.preventDefault(),n.delayId&&window.clearTimeout(n.delayId),n.intervalId&&window.clearInterval(n.intervalId),n.button.classList.remove("is-pressed"),pe.delete(e.pointerId),Se(n.key,"keyup"))}function We(){for(const e of pe.values())e.delayId&&window.clearTimeout(e.delayId),e.intervalId&&window.clearInterval(e.intervalId),e.button.classList.remove("is-pressed"),Se(e.key,"keyup");pe.clear()}ne.innerHTML=Rt();const te=document.getElementById("terminal-output"),rn=document.getElementById("terminal-form"),G=document.getElementById("terminal-input");Y(Ct(),"welcome-block");ft();function Ve(){var e,n;return((e=window.location.pathname.match(/^\/articles\/([^/]+)\/?$/))==null?void 0:e[1])??((n=window.location.hash.match(/^#article\/(.+)$/))==null?void 0:n[1])}const ve=Ve();ve&&de(ve)&&ke(ve);window.addEventListener("popstate",()=>{var n;const e=Ve();e&&de(e)?ke(e):(n=document.getElementById("article-reader"))==null||n.remove()});rn.addEventListener("submit",e=>{e.preventDefault();const n=G.value;G.value="",qe(n)});G.addEventListener("keydown",e=>{if(e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const n=e.key==="ArrowUp"?-1:1;ye=Math.max(0,Math.min(le.length,ye+n)),G.value=le[ye]??"",requestAnimationFrame(()=>G.setSelectionRange(G.value.length,G.value.length));return}if(e.key==="Tab"){e.preventDefault();const n=G.value.trim().toLowerCase(),t=It.filter(a=>a.startsWith(n));t.length===1?G.value=t[0]:t.length>1&&Y(t.map(a=>`<span class="command">${a}</span>`).join("  "))}});ne.addEventListener("click",e=>{var b,A,x;const n=e.target,t=document.querySelector("#reader-toc.is-open");t&&!n.closest("#reader-toc")&&!n.closest('[data-action="toggle-toc"]')&&t.classList.remove("is-open");const a=n.closest('[data-action="read-article"]');if(a!=null&&a.dataset.slug){ke(a.dataset.slug);return}if(n.closest('[data-action="close-reader"]')){Ge();return}const i=n.closest('[data-action="share-article"]');if(i!=null&&i.dataset.slug){Ut(i.dataset.slug,i);return}const o=n.closest('[data-action="copy-article-link"]');if(o!=null&&o.dataset.slug){Ne(o.dataset.slug,o);return}if(n.closest('[data-action="toggle-toc"]')){(b=document.getElementById("reader-toc"))==null||b.classList.toggle("is-open");return}const r=n.closest('[data-action="goto-heading"]');if(r!=null&&r.dataset.target){const S=document.getElementById("article-reader");(A=document.getElementById(r.dataset.target))==null||A.scrollIntoView({behavior:"smooth",block:"start"}),(x=S==null?void 0:S.querySelector("#reader-toc"))==null||x.classList.remove("is-open");return}const p=n.closest("[data-command]");p!=null&&p.dataset.command&&qe(p.dataset.command),n.closest('[data-action="exit-game"]')&&we(),!n.closest("a")&&!document.getElementById("game-overlay")&&!document.getElementById("article-reader")&&G.focus({preventScroll:!0})});ne.addEventListener("pointerdown",ln);ne.addEventListener("pointerup",Me);ne.addEventListener("pointercancel",Me);ne.addEventListener("lostpointercapture",Me);window.addEventListener("blur",We);document.addEventListener("keydown",e=>{e.key==="Escape"&&document.getElementById("game-overlay")&&we(),e.key==="Escape"&&document.getElementById("article-reader")&&Ge()});
