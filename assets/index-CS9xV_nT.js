...
`))}function ge(e){return e.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[n]??n)}const kt={title:"Development Is Dead",date:"2026-09-22",tags:["opinion","ai","career","italy","craft"]},St=`<p>I started in 2011, freelance until 2014, and I never left. Fifteen years. Long enough to have opinions, short enough that whoever started in 1995 gets to laugh at mine.</p>
...
`,It=Object.freeze(Object.defineProperty({__proto__:null,html:At,meta:xt},Symbol.toStringTag,{value:"Module"})),Et={title:"Iron Doctrine: building deterministic online multiplayer with a shared ECS engine",date:"2026-08-31",tags:["typescript","game-dev","multiplayer","ecs","pnpm"]},Lt=`<p><strong>Iron Doctrine</strong> is a real-time strategy game I&#39;m building in a pnpm monorepo, with a deterministic ECS engine at its core and, as of this week, a working 1v1 online mode.</p>
...
`,Mt=Object.freeze(Object.defineProperty({__proto__:null,html:Lt,meta:Et},Symbol.toStringTag,{value:"Module"})),_t={title:"Otelma: building a local LLM runtime from scratch",date:"2026-08-31",tags:["go","llm","llama-cpp","apple-silicon","ai"]},Rt=`<p><strong>Otelma</strong> is a local LLM inference runtime I&#39;m building in Go.</p>
...
`,Ct=Object.freeze(Object.defineProperty({__proto__:null,html:Rt,meta:_t},Symbol.toStringTag,{value:"Module"})),Pt={title:"I Built a CLI to Answer One Question: What Will This Change Break?",date:"2026-08-27",tags:["programming","devops","go","opensource"]},Ot=`<p>We&#39;ve all been there.</p>
...
`,jt=Object.freeze(Object.defineProperty({__proto__:null,html:Ot,meta:Pt},Symbol.toStringTag,{value:"Module"})),$t={title:"Telemaco: a headless browser engine in Rust, without the Chromium",date:"2026-09-04",tags:["rust","browser","scraping","ai-agents","cdp","sideprojects"]},Dt=`<p><strong>Telemaco</strong> is a headless browser engine I&#39;ve been building in Rust. It runs real JavaScript through V8, keeps a real DOM tree, owns its own layout and paint pipeline, and speaks the Chrome DevTools Protocol, so Puppeteer and Playwright connect to it out of the box. No Chromium, no WebView, no 300 MB download. A 70 MB binary that starts instantly and loads a page in ~85 ms.</p>
...
`,Gt=Object.freeze(Object.defineProperty({__proto__:null,html:Ht,meta:qt},Symbol.toStringTag,{value:"Module"}));function Nt(e){return[...e].sort((n,t)=>n.date.localeCompare(t.date))}const Wt=Object.assign({"/src/content/articles/development-is-dead.md":Tt,"/src/content/articles/gitlab-alert.md":It,"/src/content/articles/iron-doctrine.md":Mt,"/src/content/articles/otelma.md":Ct,"/src/content/articles/serval-cli.md":jt,"/src/content/articles/telemaco.md":Bt,"/src/content/articles/wir-what-is-running.md":Gt}),Ee=new Map,K=Nt(Object.entries(Wt).map(([e,n])=>{const t=e.split("/").pop().replace(/\.md$/,"");return Ee.set(t,n.html),{slug:t,title:n.meta.title??t,date:n.meta.date??"",tags:n.meta.tags??[]}}));function pe(e){return Ee.has(e)?Ee.get(e):null}const Be="alberto@portfolio:~",Ft=Object.freeze(["help","about","skills","experience","projects","lab","articles","utils","contact","cv","games","play","ls","tree","neofetch","history","date","clear","rss"]),zt=Object.freeze([["help","help"],["about","about"],["skills","skills"],["projects","projects"],["lab","lab"],["articles","articles"],["utils","utils"],["games","games"],["contact","contact"]]),we=Object.freeze({space:"SPACE INVADERS",tetris:"TETRIS",pong:"PONG",flappy:"FLAPPY BIRD"}),Vt=Object.freeze({space:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"FIRE",key:" "},{label:"→",key:"ArrowRight"}],tetris:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"ROT",key:"ArrowUp"},{label:"→",key:"ArrowRight"},{label:"↓",key:"ArrowDown"}],pong:[{label:"START",key:"Enter"},{label:"↑",key:"ArrowUp"},{label:"↓",key:"ArrowDown"}],flappy:[{label:"START",key:"Enter"},{label:"FLAP",key:" "}]}),qe=Object.freeze({space:ct,tetris:gt,pong:yt,flappy:bt}),He=Object.freeze(["        /\\_/\\","       ( o.o )","        > ^ <","       /|   |\\","      (_|   |_)","         W W","","      I LOVE CAT"]),Le=Object.freeze(["    _    _     ____   _____","   / \\  | |   | __ ) |__  /","  / _ \\ | |   |  _ \\   / /"," / ___ \\| |___| |_) | / /_","/_/   \\_\\_____|____/ /____|"]),$e="#%@*+=-<>/\\|",Yt=new Set(["ArrowLeft","ArrowRight","ArrowDown"]),he=new Map,se=[];let be=0,te=null,de=null,ee=null,X=null;const oe=document.getElementById("app");function Ut(){const e=zt.map(([n,t])=>`<button class="mobile-command" type="button" data-command="${t}">${n}</button>`).join("");return`<main class="terminal" aria-label="Alberto Barrago portfolio terminal">
...
<div class="output-note">Tip: press <span class="key">Tab</span> to autocomplete and <span class="key">↑</span>/<span class="key">↓</span> for history.</div>`}function Kt(){return`<div class="output-title">${Ie}</div>
...
<p class="prose">${tt}</p>
<div class="output-links"><button class="inline-command command" data-command="projects">view projects</button><button class="inline-command command" data-command="contact">contact me</button><button class="inline-command command" data-command="cv">download cv</button></div>`}function Xt(){return`<div class="output-title">Technical toolbox</div>
...
<div class="timeline">${ot.map(e=>`<article class="timeline-item">
	...
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function Qt(){return`<div class="output-title">Selected projects</div>
...
</article>`).join("")}</div>`}function en(){return`<div class="output-title">Workbench Lab</div>
...
</article>`).join("")}`}function Ne(e){if(!e)return e;const n=new Date(`${e}T00:00:00`);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("it-IT",{day:"2-digit",month:"2-digit",year:"numeric"}).format(n)}function tn(){return K.length===0?`<div class="output-title">Articles</div>
...
<div class="project-list">${[...K].sort((n,t)=>n.date.localeCompare(t.date)).map(n=>`<article class="project-item">
...
</article>`).join("")}</div>`}const nn=200;function on(e){const n=e.replace(/<[^>]*>/g," ").replace(/\s+/g," ").trim(),t=n?n.split(" ").length:0;return{words:t,chars:n.length,minutes:Math.max(1,Math.round(t/nn))}}function an(e){const n=K.findIndex(p=>p.slug===e),t=K[n],a=on(pe(e)??""),o=K[n-1],i=K[n+1],r=[o?`<button class="reader-nav-link" type="button" data-action="read-article" data-slug="${o.slug}">← ${o.title}</button>`:"<span></span>",i?`<button class="reader-nav-link reader-nav-next" type="button" data-action="read-article" data-slug="${i.slug}">${i.title} →</button>`:"<span></span>"].join("");return`<div class="article-reader" id="article-reader">
	...
	</div>`}function rn(e){return e.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}function sn(e){const n=e.querySelector("#reader-toc"),t=e.querySelectorAll(".prose h2, .prose h3");if(t.length===0)return;const a=new Set,o=Array.from(t).map(r=>{let p=rn(r.textContent??"");for(;a.has(p)||!p;)p=`${p||"section"}-${a.size+1}`;return a.add(p),r.id=p,{id:p,text:r.textContent??"",level:r.tagName==="H2"?2:3}});n.innerHTML=`<span class="reader-toc-title">chapters</span><ol class="reader-toc-list">${o.map(r=>`<li class="reader-toc-item level-${r.level}"><button class="reader-toc-link" type="button" data-action="goto-heading" data-target="${r.id}">${r.text}</button></li>`).join("")}</ol>`,n.hidden=!1,e.classList.add("has-toc");const i=e.querySelector("#reader-toc-toggle");i&&(i.hidden=!1),ln(e,Array.from(t))}function ln(e,n){ee==null||ee.disconnect(),X==null||X.container.removeEventListener("scroll",X.handler),X=null;const t=e.querySelector(".article-reader-body"),a=e.querySelectorAll(".reader-toc-link"),o=new Set,i=b=>{a.forEach(A=>A.classList.toggle("is-active",A.dataset.target===b))},r=()=>t.scrollTop+t.clientHeight>=t.scrollHeight-4;ee=new IntersectionObserver(b=>{for(const k of b)k.isIntersecting?o.add(k.target.id):o.delete(k.target.id);const A=n.find(k=>o.has(k.id));A?i(A.id):r()&&i(n[n.length-1].id)},{root:t,rootMargin:"0px 0px -72% 0px",threshold:0}),n.forEach(b=>ee.observe(b)),i(n[0].id);const p=()=>{r()&&i(n[n.length-1].id)};t.addEventListener("scroll",p,{passive:!0}),X={container:t,handler:p}}function Te(e){var a;(a=document.getElementById("article-reader"))==null||a.remove(),D.blur();const n=document.createElement("div");n.innerHTML=an(e);const t=n.firstElementChild;oe.appendChild(t),t.scrollTop=0,sn(t),window.location.pathname!==`/articles/${e}/`&&window.history.pushState(null,"",`/articles/${e}/`)}function We(){var e;ee==null||ee.disconnect(),ee=null,X==null||X.container.removeEventListener("scroll",X.handler),X=null,(e=document.getElementById("article-reader"))==null||e.remove(),window.location.pathname.startsWith("/articles/")&&window.history.pushState(null,"","/"),D==null||D.focus({preventScroll:!0})}function Me(e){return`${window.location.origin}/articles/${e}/`}function cn(e){const n=e.textContent;e.textContent="copied ✓",e.disabled=!0,window.setTimeout(()=>{e.textContent=n,e.disabled=!1},1500)}async function Fe(e,n){try{await navigator.clipboard.writeText(Me(e)),cn(n)}catch{window.prompt("Copy this link:",Me(e))}}async function dn(e,n){const t=K.find(o=>o.slug===e),a=Me(e);if(navigator.share){try{await navigator.share({title:(t==null?void 0:t.title)??e,url:a})}catch{}return}await Fe(e,n)}function pn(){return`<div class="output-title">/utils</div>
...
<span class="label">location</span><span>${Se}</span></div>`}function hn(){return`<div class="output-title">/games</div>
...
<div class="output-note">Games open fullscreen. Press <span class="key">Esc</span> to return.</div>`}function un(){return`<div class="tree"><span class="blue">~</span>
...
└── <button class="inline-command directory" data-command="games">games/</button></div>`}function mn(){return`<div class="neofetch"><div class="neofetch-mark" aria-hidden="true">╭─────╮
│ A B │
│ L Z │
...
<span class="palette"><i></i><i></i><i></i><i></i><i></i><i></i></span></div></div>`}function fn(){return'<div class="ls-output"><button class="inline-command file" data-command="about">about.txt</button><button class="inline-command directory" data-command="skills">skills/</button><button class="inline-command file" data-command="experience">experience.log</button><button class="inline-command directory" data-command="projects">projects/</button><button class="inline-command directory" data-command="lab">lab/</button><button class="inline-command directory" data-command="articles">articles/</button><button class="inline-command directory" data-command="utils">utils/</button><button class="inline-command file" data-command="contact">contact.vcf</button><button class="inline-command directory" data-command="games">games/</button></div>'}function ze(e,n){return e.map(t=>t.split("").map(a=>a===" "||Math.random()>=n?a:$e[Math.floor(Math.random()*$e.length)]).join("")).join(`
`)}function gn(e){return ze(He,e)}function yn(){const e=ne.querySelector(".ascii-banner");if(!e)return;const n=Le.join(`
`),t=9;let a=0;const o=window.setInterval(()=>{if(a+=1,a>=t){window.clearInterval(o),e.textContent=n;return}e.textContent=ze(Le,Math.max(0,.55-a*.06))},70)}function bn(){const e=document.createElement("div");e.className="output-block ascii-banner accent",ne.appendChild(e);const n=6;let t=0;const a=window.setInterval(()=>{t+=1,e.textContent=t>=n?He.join(`
`):gn(Math.max(0,.6-t*.12)),requestAnimationFrame(()=>{ne.scrollTop=ne.scrollHeight}),t>=n&&(window.clearInterval(a),G('<span class="green">Purring in binary.</span>'))},90)}function wn(e){const n=document.createElement("div");n.className="output-block command-echo";const t=document.createElement("span");t.className="prompt",t.innerHTML=`<span class="prompt-user">${Be}</span><span class="prompt-symbol">$</span>`;const a=document.createElement("span");a.textContent=e,n.append(t,a),ne.appendChild(n)}function G(e,n=""){const t=`output-block ${n}`.trim();for(const o of Array.from(ne.children))o.className===t&&o.innerHTML===e&&o.remove();const a=document.createElement("div");a.className=t,a.innerHTML=e,ne.appendChild(a),requestAnimationFrame(()=>{a.scrollIntoView({block:"start"})})}function Ve(e){const n=e.trim();if(!n)return;wn(n),se.at(-1)!==n&&se.push(n),be=se.length;const[t,...a]=n.split(/\s+/),o=t.toLowerCase(),i=a.join(" ").toLowerCase();if(o==="clear"){ne.replaceChildren(),G(Ge(),"welcome-block");return}if(["about","whoami","cat"].includes(o)){o!=="cat"||!i||i==="about.txt"?G(Kt()):i==="contact.vcf"?G(xe()):i.endsWith(".md")&&pe(i.slice(0,-3))?Te(i.slice(0,-3)):G(`<span class="red">cat: ${ge(i)}: No such file</span>`);return}const r={help:Jt,skills:Xt,experience:Zt,projects:Qt,lab:en,articles:tn,utils:pn,contact:xe,games:hn,ls:fn,tree:un,neofetch:mn};if(r[o]){G(r[o]());return}if(o==="cv"){lt(),G('<span class="green">Downloading albertobarrago_cv.pdf…</span>');return}if(o==="history"){G(se.map((p,b)=>`<div><span class="muted">${String(b+1).padStart(3," ")}</span>  ${ge(p)}</div>`).join(""));return}if(o==="date"){G(new Intl.DateTimeFormat("it-IT",{dateStyle:"full",timeStyle:"long"}).format(new Date));return}if(o==="rss"){G(`<div class="output-title">RSS feed</div>
<p class="prose">Subscribe to my articles feed in any RSS reader:</p>
<div class="key-value"><span class="label">url</span><a class="terminal-link" href="/feed.xml" target="_blank" rel="noopener">https://albz.it/feed.xml</a></div>`);return}if(o==="play"){vn(i)?(G(`<span class="green">Launching ${we[i]}…</span>`),Sn(i)):G(`<span class="red">Unknown game${i?`: ${ge(i)}`:""}.</span> Try <button class="inline-command command" data-command="games">games</button>.`);return}if(o==="1337"){bn();return}if(o==="sudo"&&i==="hire alberto"){G('<span class="green">Permission granted. Opening contact details…</span>'),G(xe());return}G(`<span class="red">command not found: ${ge(o)}</span><br>Type <button class="inline-command command" data-command="help">help</button> to see available commands.`)}function vn(e){return Object.hasOwn(qe,e)}function kn(e){const n=Vt[e].map(t=>`<button class="game-control-button" type="button" data-control-key="${t.key}">${t.label}</button>`).join("");return`<div class="game-fullscreen" id="game-overlay">
	...
	</div>`}function Sn(e){ve(),D.blur();const n=document.createElement("div");n.innerHTML=kn(e);const t=n.firstElementChild;oe.appendChild(t);const a=t.querySelector(".game-canvas");requestAnimationFrame(()=>{t.isConnected&&(de=qe[e](a,ve))})}function ve(){var e;de==null||de(),de=null,Ye(),(e=document.getElementById("game-overlay"))==null||e.remove(),D==null||D.focus({preventScroll:!0})}function ke(e,n){window.dispatchEvent(new KeyboardEvent(n,{key:e,bubbles:!0,cancelable:!0}))}function Tn(e){var i;const t=e.target.closest("[data-control-key]"),a=t==null?void 0:t.dataset.controlKey;if(!t||!a)return;e.preventDefault(),(i=t.setPointerCapture)==null||i.call(t,e.pointerId);const o={key:a,button:t};he.set(e.pointerId,o),t.classList.add("is-pressed"),ke(a,"keydown"),Yt.has(a)&&(o.delayId=window.setTimeout(()=>{o.intervalId=window.setInterval(()=>ke(a,"keydown"),85)},220))}function Ce(e){const n=he.get(e.pointerId);n&&(e.preventDefault(),n.delayId&&window.clearTimeout(n.delayId),n.intervalId&&window.clearInterval(n.intervalId),n.button.classList.remove("is-pressed"),he.delete(e.pointerId),ke(n.key,"keyup"))}function Ye(){for(const e of he.values())e.delayId&&window.clearTimeout(e.delayId),e.intervalId&&window.clearInterval(e.intervalId),e.button.classList.remove("is-pressed"),ke(e.key,"keyup");he.clear()}oe.innerHTML=Ut();const ne=document.getElementById("terminal-output"),xn=document.getElementById("terminal-form"),D=document.getElementById("terminal-input");G(Ge(),"welcome-block");yn();vt();function Ue(){var e,n;return((e=window.location.pathname.match(/^\/articles\/([^/]+)\/?$/))==null?void 0:e[1])??((n=window.location.hash.match(/^#article\/(.+)$/))==null?void 0:n[1])}const Ae=Ue();Ae&&pe(Ae)&&Te(Ae);window.addEventListener("popstate",()=>{var n;const e=Ue();e&&pe(e)?Te(e):(n=document.getElementById("article-reader"))==null||n.remove()});xn.addEventListener("submit",e=>{e.preventDefault();const n=D.value;D.value="",Ve(n)});D.addEventListener("input",()=>{te=null});D.addEventListener("keydown",e=>{if(e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const n=e.key==="ArrowUp"?-1:1;be=Math.max(0,Math.min(se.length,be+n)),D.value=se[be]??"",requestAnimationFrame(()=>D.setSelectionRange(D.value.length,D.value.length));return}if(e.key==="Tab"){e.preventDefault();const n=D.value.trim().toLowerCase();if(!n){G(`<span class="muted">Type 'help' to see the list of available commands.</span>`),te=null;return}const t=Ft.filter(o=>o.startsWith(n));if(t.length===0){te=null;return}if(t.length===1){D.value=t[0],te=null;return}const a=t.reduce((o,i)=>{let r=0;for(;r<o.length&&r<i.length&&o[r]===i[r];)r+=1;return o.slice(0,r)});if(a.length>n.length){D.value=a,te=null;return}te===n?(G(t.map(o=>`<span class="command">${o}</span>`).join("  ")),te=null):te=n}});oe.addEventListener("click",e=>{var b,A,k;const n=e.target,t=document.querySelector("#reader-toc.is-open");t&&!n.closest("#reader-toc")&&!n.closest('[data-action="toggle-toc"]')&&t.classList.remove("is-open");const a=n.closest('[data-action="read-article"]');if(a!=null&&a.dataset.slug){Te(a.dataset.slug);return}if(n.closest('[data-action="close-reader"]')){We();return}const o=n.closest('[data-action="share-article"]');if(o!=null&&o.dataset.slug){dn(o.dataset.slug,o);return}const i=n.closest('[data-action="copy-article-link"]');if(i!=null&&i.dataset.slug){Fe(i.dataset.slug,i);return}if(n.closest('[data-action="toggle-toc"]')){(b=document.getElementById("reader-toc"))==null||b.classList.toggle("is-open");return}const r=n.closest('[data-action="goto-heading"]');if(r!=null&&r.dataset.target){const v=document.getElementById("article-reader");(A=document.getElementById(r.dataset.target))==null||A.scrollIntoView({behavior:"smooth",block:"start"}),(k=v==null?void 0:v.querySelector("#reader-toc"))==null||k.classList.remove("is-open");return}const p=n.closest("[data-command]");p!=null&&p.dataset.command&&Ve(p.dataset.command),n.closest('[data-action="exit-game"]')&&ve(),!n.closest("a")&&!document.getElementById("game-overlay")&&!document.getElementById("article-reader")&&D.focus({preventScroll:!0})});oe.addEventListener("pointerdown",Tn);oe.addEventListener("pointerup",Ce);oe.addEventListener("pointercancel",Ce);oe.addEventListener("lostpointercapture",Ce);window.addEventListener("blur",Ye);document.addEventListener("keydown",e=>{e.key==="Escape"&&document.getElementById("game-overlay")&&ve(),e.key==="Escape"&&document.getElementById("article-reader")&&We()});
