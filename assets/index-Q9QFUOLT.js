...
> say hi: %s
> code: %s`,"color: #b8c4d4; font-family: monospace;",Be,ye.github),console.log("%csteal the theme (dark CRT terminal palette):","color: #e0af68; font-family: monospace;"),console.log(Object.entries(St).map(([n,t])=>`${n}: ${t};`).join(`
`))}function ge(e){return e.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[n]??n)}const kt={title:"Iron Doctrine: building deterministic online multiplayer with a shared ECS engine",date:"2026-08-31",tags:["typescript","game-dev","multiplayer","ecs","pnpm"]},Tt=`<p><strong>Iron Doctrine</strong> is a real-time strategy game I&#39;m building in a pnpm monorepo, with a deterministic ECS engine at its core and, as of this week, a working 1v1 online mode.</p>
...
`,xt=Object.freeze(Object.defineProperty({__proto__:null,html:Tt,meta:kt},Symbol.toStringTag,{value:"Module"})),At={title:"Otelma: building a local LLM runtime from scratch",date:"2026-08-31",tags:["go","llm","llama-cpp","apple-silicon","ai"]},It=`<p><strong>Otelma</strong> is a local LLM inference runtime I&#39;m building in Go.</p>
...
`,Et=Object.freeze(Object.defineProperty({__proto__:null,html:It,meta:At},Symbol.toStringTag,{value:"Module"})),Lt={title:"I Built a CLI to Answer One Question: What Will This Change Break?",date:"2026-08-27",tags:["programming","devops","go","opensource"]},Mt=`<p>We&#39;ve all been there.</p>
...
`,_t=Object.freeze(Object.defineProperty({__proto__:null,html:Mt,meta:Lt},Symbol.toStringTag,{value:"Module"})),Rt={title:"Telemaco: a headless browser engine in Rust, without the Chromium",date:"2026-09-04",tags:["rust","browser","scraping","ai-agents","cdp","sideprojects"]},Ct=`<p><strong>Telemaco</strong> is a headless browser engine I&#39;ve been building in Rust. It runs real JavaScript through V8, keeps a real DOM tree, owns its own layout and paint pipeline, and speaks the Chrome DevTools Protocol, so Puppeteer and Playwright connect to it out of the box. No Chromium, no WebView, no 300 MB download. A 70 MB binary that starts instantly and loads a page in ~85 ms.</p>
...
`,Pt=Object.freeze(Object.defineProperty({__proto__:null,html:Ct,meta:Rt},Symbol.toStringTag,{value:"Module"})),Ot={title:"wir: What Is Running, a Port and Process Inspector Written in C",date:"2025-12-30",tags:["c","systems-programming","cli","opensource"]},$t=`<p>I recently released <strong>wir</strong> (What Is Running), a command-line tool written in C to inspect what&#39;s running on specific ports and get detailed process information. A project born from a practical need that turned into an opportunity to explore system programming in C.</p>
<h2>The Problem</h2>
...
`,Dt=Object.freeze(Object.defineProperty({__proto__:null,html:$t,meta:Ot},Symbol.toStringTag,{value:"Module"}));function jt(e){return[...e].sort((n,t)=>n.date.localeCompare(t.date))}const Bt=Object.assign({"/src/content/articles/iron-doctrine.md":xt,"/src/content/articles/otelma.md":Et,"/src/content/articles/serval-cli.md":_t,"/src/content/articles/telemaco.md":Pt,"/src/content/articles/wir-what-is-running.md":Dt}),Ee=new Map,X=jt(Object.entries(Bt).map(([e,n])=>{const t=e.split("/").pop().replace(/\.md$/,"");return Ee.set(t,n.html),{slug:t,title:n.meta.title??t,date:n.meta.date??"",tags:n.meta.tags??[]}}));function pe(e){return Ee.has(e)?Ee.get(e):null}const He="alberto@portfolio:~",Ht=Object.freeze(["help","about","skills","experience","projects","brew","lab","articles","utils","contact","cv","games","play","ls","tree","neofetch","history","date","clear","rss"]),qt=Object.freeze([["help","help"],["about","about"],["skills","skills"],["projects","projects"],["brew","brew"],["lab","lab"],["articles","articles"],["utils","utils"],["games","games"],["contact","contact"]]),we=Object.freeze({space:"SPACE INVADERS",tetris:"TETRIS",pong:"PONG",flappy:"FLAPPY BIRD"}),Nt=Object.freeze({space:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"FIRE",key:" "},{label:"→",key:"ArrowRight"}],tetris:[{label:"START",key:"Enter"},{label:"←",key:"ArrowLeft"},{label:"ROT",key:"ArrowUp"},{label:"→",key:"ArrowRight"},{label:"↓",key:"ArrowDown"}],pong:[{label:"START",key:"Enter"},{label:"↑",key:"ArrowUp"},{label:"↓",key:"ArrowDown"}],flappy:[{label:"START",key:"Enter"},{label:"FLAP",key:" "}]}),qe=Object.freeze({space:dt,tetris:yt,pong:bt,flappy:wt}),Ne=Object.freeze(["        /\\_/\\","       ( o.o )","        > ^ <","       /|   |\\","      (_|   |_)","         W W","","      I LOVE CAT"]),Le=Object.freeze(["    _    _     ____   _____","   / \\  | |   | __ ) |__  /","  / _ \\ | |   |  _ \\   / /"," / ___ \\| |___| |_) | / /_","/_/   \\_\\_____|____/ /____|"]),De="#%@*+=-<>/\\|",Gt=new Set(["ArrowLeft","ArrowRight","ArrowDown"]),he=new Map,le=[];let be=0,te=null,de=null,ee=null,K=null;const oe=document.getElementById("app");function Ft(){const e=qt.map(([n,t])=>`<button class="mobile-command" type="button" data-command="${t}">${n}</button>`).join("");return`<main class="terminal" aria-label="Alberto Barrago portfolio terminal">
...
Type <button class="inline-command command" data-command="help">help</button> to explore, or use the shortcuts below.</div>`}function Wt(){return`<div class="output-title">Available commands</div>
<div class="command-list">${[["about","Short profile and current role"],["skills","Technical toolbox by area"],["experience","Professional timeline"],["projects","Selected open-source work and Homebrew formulae"],["brew","Alias for projects"],["lab","Experimental work in progress"],["articles","Technical articles and notes"],["rss","Subscribe to the articles feed"],["utils","Useful free resources and links"],["contact","Ways to get in touch"],["cv","Download my resume"],["games","List embedded retro games"],["play &lt;game&gt;","Launch space, tetris, pong, or flappy"],["ls / tree","Browse the portfolio filesystem"],["neofetch","Compact system profile"],["history / date / clear","Terminal utilities"]].map(([n,t])=>`<div><button class="inline-command command" data-command="${n.split(" ")[0]}">${n}</button><span class="muted">${t}</span></div>`).join("")}</div>
<div class="output-note">Tip: press <span class="key">Tab</span> to autocomplete and <span class="key">↑</span>/<span class="key">↓</span> for history.</div>`}function Vt(){return`<div class="output-title">${Ie}</div>
...
<div class="timeline">${it.map(e=>`<article class="timeline-item">
	...
	<p>${e.highlight}</p></div>
</article>`).join("")}</div>`}function je(){return`<div class="output-title">Selected projects</div>
...
</article>`).join("")}</div>`}function Ut(){return`<div class="output-title">Workbench Lab</div>
...
</article>`).join("")}`}function Fe(e){if(!e)return e;const n=new Date(`${e}T00:00:00`);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("it-IT",{day:"2-digit",month:"2-digit",year:"numeric"}).format(n)}function Jt(){return X.length===0?`<div class="output-title">Articles</div>
...
<div class="project-list">${[...X].sort((n,t)=>n.date.localeCompare(t.date)).map(n=>`<article class="project-item">
	<div><button class="terminal-link project-name inline-command" data-command="cat ${n.slug}.md">${n.title} ↗</button><span class="project-language">${Fe(n.date)}</span></div>
	<p class="muted">${n.tags.join("  ·  ")}</p>
</article>`).join("")}</div>`}const Xt=200;function Kt(e){const n=e.replace(/<[^>]*>/g," ").replace(/\s+/g," ").trim(),t=n?n.split(" ").length:0;return{words:t,chars:n.length,minutes:Math.max(1,Math.round(t/Xt))}}function Zt(e){const n=X.findIndex(p=>p.slug===e),t=X[n],a=Kt(pe(e)??""),o=X[n-1],i=X[n+1],r=[o?`<button class="reader-nav-link" type="button" data-action="read-article" data-slug="${o.slug}">← ${o.title}</button>`:"<span></span>",i?`<button class="reader-nav-link reader-nav-next" type="button" data-action="read-article" data-slug="${i.slug}">${i.title} →</button>`:"<span></span>"].join("");return`<div class="article-reader" id="article-reader">
		...
		<div class="article-reader-body">
			...
			<div class="article-reader-main">
				<article class="prose">
					<h1>${t.title}</h1>
					<p class="reader-meta muted">${Fe(t.date)}${t.tags.length?` · ${t.tags.join(" · ")}`:""}</p>
	...
	</div>`}function Qt(e){return e.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}function en(e){const n=e.querySelector("#reader-toc"),t=e.querySelectorAll(".prose h2, .prose h3");if(t.length===0)return;const a=new Set,o=Array.from(t).map(r=>{let p=Qt(r.textContent??"");for(;a.has(p)||!p;)p=`${p||"section"}-${a.size+1}`;return a.add(p),r.id=p,{id:p,text:r.textContent??"",level:r.tagName==="H2"?2:3}});n.innerHTML=`<span class="reader-toc-title">chapters</span><ol class="reader-toc-list">${o.map(r=>`<li class="reader-toc-item level-${r.level}"><button class="reader-toc-link" type="button" data-action="goto-heading" data-target="${r.id}">${r.text}</button></li>`).join("")}</ol>`,n.hidden=!1,e.classList.add("has-toc");const i=e.querySelector("#reader-toc-toggle");i&&(i.hidden=!1),tn(e,Array.from(t))}function tn(e,n){ee==null||ee.disconnect(),K==null||K.container.removeEventListener("scroll",K.handler),K=null;const t=e.querySelector(".article-reader-body"),a=e.querySelectorAll(".reader-toc-link"),o=new Set,i=b=>{a.forEach(A=>A.classList.toggle("is-active",A.dataset.target===b))},r=()=>t.scrollTop+t.clientHeight>=t.scrollHeight-4;ee=new IntersectionObserver(b=>{for(const v of b)v.isIntersecting?o.add(v.target.id):o.delete(v.target.id);const A=n.find(v=>o.has(v.id));A?i(A.id):r()&&i(n[n.length-1].id)},{root:t,rootMargin:"0px 0px -72% 0px",threshold:0}),n.forEach(b=>ee.observe(b)),i(n[0].id);const p=()=>{r()&&i(n[n.length-1].id)};t.addEventListener("scroll",p,{passive:!0}),K={container:t,handler:p}}function Te(e){var a;(a=document.getElementById("article-reader"))==null||a.remove(),j.blur();const n=document.createElement("div");n.innerHTML=Zt(e);const t=n.firstElementChild;oe.appendChild(t),t.scrollTop=0,en(t),window.location.pathname!==`/articles/${e}/`&&window.history.pushState(null,"",`/articles/${e}/`)}function We(){var e;ee==null||ee.disconnect(),ee=null,K==null||K.container.removeEventListener("scroll",K.handler),K=null,(e=document.getElementById("article-reader"))==null||e.remove(),window.location.pathname.startsWith("/articles/")&&window.history.pushState(null,"","/"),j==null||j.focus({preventScroll:!0})}function Me(e){return`${window.location.origin}/articles/${e}/`}function nn(e){const n=e.textContent;e.textContent="copied ✓",e.disabled=!0,window.setTimeout(()=>{e.textContent=n,e.disabled=!1},1500)}async function Ve(e,n){try{await navigator.clipboard.writeText(Me(e)),nn(n)}catch{window.prompt("Copy this link:",Me(e))}}async function on(e,n){const t=X.find(o=>o.slug===e),a=Me(e);if(navigator.share){try{await navigator.share({title:(t==null?void 0:t.title)??e,url:a})}catch{}return}await Ve(e,n)}function an(){return`<div class="output-title">/utils</div>
...
<span class="label">location</span><span>${ke}</span></div>`}function rn(){return`<div class="output-title">/games</div>
...
<div class="output-note">Games open fullscreen. Press <span class="key">Esc</span> to return.</div>`}function ln(){return`<div class="tree"><span class="blue">~</span>
...
└── <button class="inline-command directory" data-command="games">games/</button></div>`}function sn(){return`<div class="neofetch"><div class="neofetch-mark" aria-hidden="true">╭─────╮
│ A B │
│ L Z │
...
<span class="palette"><i></i><i></i><i></i><i></i><i></i><i></i></span></div></div>`}function cn(){return'<div class="ls-output"><button class="inline-command file" data-command="about">about.txt</button><button class="inline-command directory" data-command="skills">skills/</button><button class="inline-command file" data-command="experience">experience.log</button><button class="inline-command directory" data-command="projects">projects/</button><button class="inline-command directory" data-command="brew">brew/</button><button class="inline-command directory" data-command="lab">lab/</button><button class="inline-command directory" data-command="articles">articles/</button><button class="inline-command directory" data-command="utils">utils/</button><button class="inline-command file" data-command="contact">contact.vcf</button><button class="inline-command directory" data-command="games">games/</button></div>'}function ze(e,n){return e.map(t=>t.split("").map(a=>a===" "||Math.random()>=n?a:De[Math.floor(Math.random()*De.length)]).join("")).join(`
`)}function dn(e){return ze(Ne,e)}function pn(){const e=ne.querySelector(".ascii-banner");if(!e)return;const n=Le.join(`
`),t=9;let a=0;const o=window.setInterval(()=>{if(a+=1,a>=t){window.clearInterval(o),e.textContent=n;return}e.textContent=ze(Le,Math.max(0,.55-a*.06))},70)}function hn(){const e=document.createElement("div");e.className="output-block ascii-banner accent",ne.appendChild(e);const n=6;let t=0;const a=window.setInterval(()=>{t+=1,e.textContent=t>=n?Ne.join(`
`):dn(Math.max(0,.6-t*.12)),requestAnimationFrame(()=>{ne.scrollTop=ne.scrollHeight}),t>=n&&(window.clearInterval(a),N('<span class="green">Purring in binary.</span>'))},90)}function un(e){const n=document.createElement("div");n.className="output-block command-echo";const t=document.createElement("span");t.className="prompt",t.innerHTML=`<span class="prompt-user">${He}</span><span class="prompt-symbol">$</span>`;const a=document.createElement("span");a.textContent=e,n.append(t,a),ne.appendChild(n)}function N(e,n=""){const t=`output-block ${n}`.trim();for(const o of Array.from(ne.children))o.className===t&&o.innerHTML===e&&o.remove();const a=document.createElement("div");a.className=t,a.innerHTML=e,ne.appendChild(a),requestAnimationFrame(()=>{a.scrollIntoView({block:"start"})})}function Ye(e){const n=e.trim();if(!n)return;un(n),le.at(-1)!==n&&le.push(n),be=le.length;const[t,...a]=n.split(/\s+/),o=t.toLowerCase(),i=a.join(" ").toLowerCase();if(o==="clear"){ne.replaceChildren(),N(Ge(),"welcome-block");return}if(["about","whoami","cat"].includes(o)){o!=="cat"||!i||i==="about.txt"?N(Vt()):i==="contact.vcf"?N(xe()):i.endsWith(".md")&&pe(i.slice(0,-3))?Te(i.slice(0,-3)):N(`<span class="red">cat: ${ge(i)}: No such file</span>`);return}const r={help:Wt,skills:zt,experience:Yt,projects:je,brew:je,lab:Ut,articles:Jt,utils:an,contact:xe,games:rn,ls:cn,tree:ln,neofetch:sn};if(r[o]){N(r[o]());return}if(o==="cv"){ct(),N('<span class="green">Downloading albertobarrago_cv.pdf…</span>');return}if(o==="history"){N(le.map((p,b)=>`<div><span class="muted">${String(b+1).padStart(3," ")}</span>  ${ge(p)}</div>`).join(""));return}if(o==="date"){N(new Intl.DateTimeFormat("it-IT",{dateStyle:"full",timeStyle:"long"}).format(new Date));return}if(o==="rss"){N(`<div class="output-title">RSS feed</div>
<p class="prose">Subscribe to my articles feed in any RSS reader:</p>
<div class="key-value"><span class="label">url</span><a class="terminal-link" href="/feed.xml" target="_blank" rel="noopener">https://albz.it/feed.xml</a></div>`);return}if(o==="play"){mn(i)?(N(`<span class="green">Launching ${we[i]}…</span>`),gn(i)):N(`<span class="red">Unknown game${i?`: ${ge(i)}`:""}.</span> Try <button class="inline-command command" data-command="games">games</button>.`);return}if(o==="1337"){hn();return}if(o==="sudo"&&i==="hire alberto"){N('<span class="green">Permission granted. Opening contact details…</span>'),N(xe());return}N(`<span class="red">command not found: ${ge(o)}</span><br>Type <button class="inline-command command" data-command="help">help</button> to see available commands.`)}function mn(e){return Object.hasOwn(qe,e)}function fn(e){const n=Nt[e].map(t=>`<button class="game-control-button" type="button" data-control-key="${t.key}">${t.label}</button>`).join("");return`<div class="game-fullscreen" id="game-overlay">
	...
	</div>`}function gn(e){Se(),j.blur();const n=document.createElement("div");n.innerHTML=fn(e);const t=n.firstElementChild;oe.appendChild(t);const a=t.querySelector(".game-canvas");requestAnimationFrame(()=>{t.isConnected&&(de=qe[e](a,Se))})}function Se(){var e;de==null||de(),de=null,Ue(),(e=document.getElementById("game-overlay"))==null||e.remove(),j==null||j.focus({preventScroll:!0})}function ve(e,n){window.dispatchEvent(new KeyboardEvent(n,{key:e,bubbles:!0,cancelable:!0}))}function yn(e){var i;const t=e.target.closest("[data-control-key]"),a=t==null?void 0:t.dataset.controlKey;if(!t||!a)return;e.preventDefault(),(i=t.setPointerCapture)==null||i.call(t,e.pointerId);const o={key:a,button:t};he.set(e.pointerId,o),t.classList.add("is-pressed"),ve(a,"keydown"),Gt.has(a)&&(o.delayId=window.setTimeout(()=>{o.intervalId=window.setInterval(()=>ve(a,"keydown"),85)},220))}function Ce(e){const n=he.get(e.pointerId);n&&(e.preventDefault(),n.delayId&&window.clearTimeout(n.delayId),n.intervalId&&window.clearInterval(n.intervalId),n.button.classList.remove("is-pressed"),he.delete(e.pointerId),ve(n.key,"keyup"))}function Ue(){for(const e of he.values())e.delayId&&window.clearTimeout(e.delayId),e.intervalId&&window.clearInterval(e.intervalId),e.button.classList.remove("is-pressed"),ve(e.key,"keyup");he.clear()}oe.innerHTML=Ft();const ne=document.getElementById("terminal-output"),bn=document.getElementById("terminal-form"),j=document.getElementById("terminal-input");N(Ge(),"welcome-block");pn();vt();function Je(){var e,n;return((e=window.location.pathname.match(/^\/articles\/([^/]+)\/?$/))==null?void 0:e[1])??((n=window.location.hash.match(/^#article\/(.+)$/))==null?void 0:n[1])}const Ae=Je();Ae&&pe(Ae)&&Te(Ae);window.addEventListener("popstate",()=>{var n;const e=Je();e&&pe(e)?Te(e):(n=document.getElementById("article-reader"))==null||n.remove()});bn.addEventListener("submit",e=>{e.preventDefault();const n=j.value;j.value="",Ye(n)});j.addEventListener("input",()=>{te=null});j.addEventListener("keydown",e=>{if(e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const n=e.key==="ArrowUp"?-1:1;be=Math.max(0,Math.min(le.length,be+n)),j.value=le[be]??"",requestAnimationFrame(()=>j.setSelectionRange(j.value.length,j.value.length));return}if(e.key==="Tab"){e.preventDefault();const n=j.value.trim().toLowerCase();if(!n){N(`<span class="muted">Type 'help' to see the list of available commands.</span>`),te=null;return}const t=Ht.filter(o=>o.startsWith(n));if(t.length===0){te=null;return}if(t.length===1){j.value=t[0],te=null;return}const a=t.reduce((o,i)=>{let r=0;for(;r<o.length&&r<i.length&&o[r]===i[r];)r+=1;return o.slice(0,r)});if(a.length>n.length){j.value=a,te=null;return}te===n?(N(t.map(o=>`<span class="command">${o}</span>`).join("  ")),te=null):te=n}});oe.addEventListener("click",e=>{var b,A,v;const n=e.target,t=document.querySelector("#reader-toc.is-open");t&&!n.closest("#reader-toc")&&!n.closest('[data-action="toggle-toc"]')&&t.classList.remove("is-open");const a=n.closest('[data-action="read-article"]');if(a!=null&&a.dataset.slug){Te(a.dataset.slug);return}if(n.closest('[data-action="close-reader"]')){We();return}const o=n.closest('[data-action="share-article"]');if(o!=null&&o.dataset.slug){on(o.dataset.slug,o);return}const i=n.closest('[data-action="copy-article-link"]');if(i!=null&&i.dataset.slug){Ve(i.dataset.slug,i);return}if(n.closest('[data-action="toggle-toc"]')){(b=document.getElementById("reader-toc"))==null||b.classList.toggle("is-open");return}const r=n.closest('[data-action="goto-heading"]');if(r!=null&&r.dataset.target){const S=document.getElementById("article-reader");(A=document.getElementById(r.dataset.target))==null||A.scrollIntoView({behavior:"smooth",block:"start"}),(v=S==null?void 0:S.querySelector("#reader-toc"))==null||v.classList.remove("is-open");return}const p=n.closest("[data-command]");p!=null&&p.dataset.command&&Ye(p.dataset.command),n.closest('[data-action="exit-game"]')&&Se(),!n.closest("a")&&!document.getElementById("game-overlay")&&!document.getElementById("article-reader")&&j.focus({preventScroll:!0})});oe.addEventListener("pointerdown",yn);oe.addEventListener("pointerup",Ce);oe.addEventListener("pointercancel",Ce);oe.addEventListener("lostpointercapture",Ce);window.addEventListener("blur",Ue);document.addEventListener("keydown",e=>{e.key==="Escape"&&document.getElementById("game-overlay")&&Se(),e.key==="Escape"&&document.getElementById("article-reader")&&We()});
